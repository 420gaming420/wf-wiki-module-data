...
buildInfobox = function(frame)
	...
	Infobox:group():header('Statistics')
			...
			:srow('EHP', frame:expandTemplate{title='text',args={'','Effective Hit Points (EHP)',hover='Effective amount of hit points, taking health, armor and shields into account.',cursor='help'}}, 'out_ehp', '&ndash;&ndash;')
		:done()
	...
	Infobox:group():header('[[Enemy Level Scaling|Level Scaling]]')
			...
			:srow('SelectedLevel', frame:expandTemplate{title='text', args={'','Selected Level',hover='For higher enemy levels input the value manually.',cursor='help'}}, 'out_lvl', '&ndash;&ndash;', '<span id="reset_btn"></span>')
			...
			:srow('PlayerCount', frame:expandTemplate{title='text', args={'','Player Count',hover='If Empowered Enemies is enabled, the Health and Shields of enemies will multiply depending on how many players are in a squad. 1 Player: 2.5x, 2 Players: 3.0x, 3 Players: 3.5x, 4 Players: 4.0x.',cursor='help'}}, 'player_count', '&ndash;&ndash;')
		:done()
