...
function p._Dis(name, color, size)
    ...
    if name  == nil then
        ...
        return '[['..link..'|<span style="font-size:'..size..'px; color:'..color..'; display:inline; position:relative; top:2px">'..dots..'</span>]]'
    end
end
        ...
        if (textexist == 'text' or textexist == 'Text') then
            ...
            if(ignoreTextColor == nil or not ignoreTextColor) then
                if(tooltip ~= nil and tooltip ~= '') then
                    return span1..'[[File:'..iconFile..'|link='..link..'|'..tooltip..']] [['..link..'|<span style=\"color:'..textcolor..';\">'..iconname..'</span>]]'..span2
                else
                    return span1..'[[File:'..iconFile..'|link='..link..']] [['..link..'|<span style=\"color:'..textcolor..';\">'..iconname..'</span>]]'..span2
                end
            else
                if(tooltip ~= nil and tooltip ~= '') then
