...
buildInfobox = function(frame)
	...
	local Infobox = InfoboxBuilder('WARFRAME Wiki:L10n/general.json', 'WARFRAME Wiki:L10n/meta.json')
		...
		:image(resourceData.ContainerImage and { {image=resourceData.Image,label='Pickup'}, {image=resourceData.ContainerImage,label='Deposit'} }
			...
			or 'Panel.png')
		:group()
			:caption('Tradable', resourceData.Tradable and "[[File:TradableIcon.png|x32px|class=icon dark-invert]] [[Trading|<span style=\"color:var(--positive-text-color)\">Tradeable</span>]][[Category:Tradeable Resources]]" or "[[Trading|<span style=\"color:var(--negative-text-color)\">Untradeable</span>]][[Category:Untradeable Resources]]")
		:done()
