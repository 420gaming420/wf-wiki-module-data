...
local ResourceData = {
	...
	["Destreza Incarnon Genesis"] = {
		Description = "Awaken this weapon's ability to summon ghostly rapiers that fly forth upon Heavy Attacks, while Heavy Attack kills grant <DT_PUNCTURE_COLOR>​ Puncture Damage in Incarnon Form.",
	...
	["Ballistica Incarnon Genesis"] = {
		Description = "Awaken this weapon's ability to fire cross-shaped projectiles high in <DT_SLASH_COLOR> Slash Damage in Incarnon Form.",
