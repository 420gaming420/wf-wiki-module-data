...
function p.tooltipText(frame)
    ...
    if getActualIcon == true and Mod.Image ~= nil then
        return '<span class="mod-tooltip" data-param="'..Mod.Name..'" style="white-space:pre">[[File:'..Mod.Image..'|x19px|link='..link..']]&thinsp;'..fullLink..'</span>'
    elseif simpleIcon == true then
        return '<span class="mod-tooltip" data-param="'..Mod.Name..'" style="white-space:pre">[[File:Mod minimap icon.png|x19px|link='..link..']]&thinsp;'..fullLink..'</span>'
    elseif Shared.contains(rarityList, Mod.Rarity) then
        ...
        return '<span class="mod-tooltip" data-param="'..Mod.Name..'" style="white-space:pre">[[File:'..image..'|x19px|link='..link..']]&thinsp;'..fullLink..'</span>'
    else
