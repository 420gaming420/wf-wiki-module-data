---
title: "Module:Companions/infobox"
wiki_url: "https://wiki.warframe.com/w/Module/Companions/infobox"
wiki_timestamp: "2026-05-12T11:50:03Z"
---

*Documentation for this module may be created at [Module:Companions/infobox/doc](/w/Module:Companions/infobox/doc?action=edit&redlink=1 "Module:Companions/infobox/doc (page does not exist)")*
...
buildInfobox = function(frame)
	...
	local Infobox = InfoboxBuilder('WARFRAME Wiki:L10n/general.json', 'WARFRAME Wiki:L10n/weapons.json', 'WARFRAME Wiki:L10n/meta.json')
		...
		:image(imageGallery)
		:group()
			:caption('Tradable', companion.Tradable and "[[File:TradableIcon.png|x32px|class=icon dark-invert]] [[Trading|Tradeable]]" or "[[Trading|Untradeable]]")
