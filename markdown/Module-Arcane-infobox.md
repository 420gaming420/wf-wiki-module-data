...
buildInfobox = function(frame)
	...
	local Infobox = InfoboxBuilder('WARFRAME Wiki:L10n/general.json', 'WARFRAME Wiki:L10n/meta.json')
		...
		:group()
			...
			:caption('Tradable', '[[File:TradableIcon.png|x32px|class=icon dark-invert]] [[Trading|%s]]', 'tradable')
		:done()
		...
		:group():header('%s', 'general-information')
			...
			--:row('InternalName', '%s', arcaneData.InternalName and ''..arcaneData.InternalName..'' or nil, 'internal-name')
		:done()
