---
title: "Module:CroqueTest2"
wiki_url: "https://wiki.warframe.com/w/Module/CroqueTest2"
wiki_timestamp: "2018-12-23T15:54:07Z"
---

*Documentation for this module may be created at [Module:CroqueTest2/doc](/w/Module:CroqueTest2/doc?action=edit&redlink=1 "Module:CroqueTest2/doc (page does not exist)")*
...
function unescapePatch(line)
    ...
    lineout=string.gsub(lineout,"{{Clr}}",'' )
    lineout=string.gsub(lineout,"{{clr}}",'' )
    --lineout=string.gsub(line,"%%[","[")
...
\n----\n'
                                        elseif(isTableHeader) then
                                            ...
                                            line=string.gsub(line,"{{!}}%-{{!!!}}",'| ')                                             line=string.gsub(line,"{{!!!}}",' | ')                                             result=result..line..' |
\n'
                                        else
                                            line=string.gsub(line,"!}}%-(.-){{!","!}}-{{!")
                                            line=string.gsub(line,"{{!}}%-{{!}}",'| ')                                             line=string.gsub(line,"{{!}}",' | ')                                             result=result..line..' |
...
\n"
        if(updt["image"]~=nil and updt["image"][1]~="") then
            --result=result.."[[File:"..updt["image"][1].."|660px|center]]  
"
        end
