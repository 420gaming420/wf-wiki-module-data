---
title: "Module:ChickenArchive"
wiki_url: "https://wiki.warframe.com/w/Module/ChickenArchive"
wiki_timestamp: "2015-05-07T08:11:57Z"
---

*Documentation for this module may be created at [Module:ChickenArchive/doc](/w/Module:ChickenArchive/doc?action=edit&redlink=1 "Module:ChickenArchive/doc (page does not exist)")*
...
local str = string.gsub(" "..string.lower( str ), "%W%l", string.upper)
...
--start generating div stacks for tenno script
	while char_list[j+1] ~= nil do
		...
		return table.concat(char_list, ",")..table.concat(final_gen)
end
