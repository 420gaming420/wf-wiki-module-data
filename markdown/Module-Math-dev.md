---
title: "Module:Math/dev"
wiki_url: "https://wiki.warframe.com/w/Module/Math/dev"
wiki_timestamp: "2021-10-14T23:43:13Z"
---

*Documentation for this module may be created at [Module:Math/dev/doc](/w/Module:Math/dev/doc?action=edit&redlink=1 "Module:Math/dev/doc (page does not exist)")*
...
--  Module variables  ----------------------------------------------------------
local patts = {"'", "°",		"%%",   "−",  "−", "÷", "•",  "×",  "×", "{{", "}}", "{",  "}",  "%[", "%]",	 "e%+",	"e%-",	 "γ",  "φ",  "π",  "#e", "#gamma", "#phi", "#pi", "%)%(",   "", "", "trunc%(", "floor%(", "ceil%(", "exp%(", "not%(", "abs%(", "asin%(", "acos%(", "atan%(", "sin%(", "cos%(", "tan%(", "ln%(", "mod", "true", "false"};
