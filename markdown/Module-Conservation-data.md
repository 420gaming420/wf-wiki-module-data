---
title: "Module:Conservation/data"
wiki_url: "https://wiki.warframe.com/w/Module/Conservation/data"
wiki_timestamp: "2025-09-14T20:40:20Z"
---
...
:   *Last updated: Sun, 14 Sep 2025 20:40:20 +0000 (UTC) by [User:Headbox8424](/w/User:Headbox8424 "User:Headbox8424") ([change log](https://wiki.warframe.com/w/Module:Conservation/data?diff=0))*

## Animal Entry Schema

[[edit source](/w/Module:Conservation/data/doc?action=edit&section=T-1 "Edit section's source code: Animal Entry Schema")]
...
[[edit source](/w/Module:Conservation/data/doc?action=edit&section=T-2 "Edit section's source code: Conservation Data")]
...
return {
	Animals = {
		...
		["Amethyst Nexifera"] = {
			...
			Intro = "Nexifera can't be lured out via the normal Track and Tranq process.  
They only spawn naturally in big caves near the Catabolic Gutter hanging from the ceiling.  
Their hard lower exterior block all Tranq-Shots.  
Additionally, They are 75% resistant to all Warframe abilities. Meaning all Duration gets quartered. Their resistance can accumulate, causing consecutive use of the same ability to have even less duration, eventually becoming outright immune.",
			Introduced = "29.5",
		...
		["Bau Vasca Kavat"] = {
			...
			Intro = "Vasca Kavats only appear during nighttime in the Plains of Eidolon.   
...
When roaming, Vasca Kavats will appear in groups of three, but when called from a calling point only one will spawn.",
		...
		["Brindle Kubrodon"] = {
			...
			Intro = "True to its status as the apex predator, the Kubrodon's more acute sense of smell allows them to locate their pursuers, and will use a ramming attack to make good their escape. Must be shot twice with the Tranq Rifle to be brought down.   
...
Despite being mentioned to travel in groups, only one Kubrodon will respond to the lure's call.",
		...
		["Common Condroc"] = {
			...
			Intro = "When roaming, Condrocs will appear in groups of two or three and are already stationed on the ground, but when called from a calling point only one will spawn.   
...
Condrocs are a flying species, making them difficult to capture until they land at the calling point.",
		...
		["Crescent Vulpaphyla"] = {
			...
			Intro = "A rare Vulpaphyla subspecies that prefers  [[Vome (Deimos)|Vome]] appearing almost exclusively during its phase.  
[[Vulpaphyla (Conservation)|Vulpaphylas]] can be attacked by the Infested before or after sedating, causing them to become ''Weakened''. Capturing a Vulpaphyla in this state allows them to be used as a modular [[Companion]] through a process called Revivification with [[Son]].",
			Introduced = "29.0",
			MaxAge = { Month = 2, Year = 1 },
			MaxWeight = 14.5,
		...
		["Dappled Horrasque"] = {
			...
			Intro = "Between the starting point and the calling point, a trail of {{D|Toxin}} damaging scat will line next to their footprints.   
...
Condrocs are a flying species, making them difficult to capture until they land at the calling point.",
		...
		["Green Velocipod"] = {
			...
			MinAge = { Month = 10, Year = 0 },
			MinWeight = 0.01,
			Notes = "A common, green Velocipod subspecies.  
Green Velocipods appear to spawn more likely in the south-west.",
			Origin = "Cambion Drift",
			Rarity = "Uncommon",
			Reward = "",
			Standing = 0,
...
Horrasques will crawl underground, periodically exposing their heads. If they reach the calling point they will surface and expose their whole body, making perfect captures much easier. Must be shot '''two times''' with the Tranq Rifle to be brought down.",
		...
		["Howler Undazoa"] = {
			...
			Intro = "A rare Undazoa subspecies that prefers [[Vome (Deimos)|Vome]] appearing almost exclusively during its phase.  
Undazoa approach the Call-Point in the Exocrine, [[Cambion Drift|Cambion Drifts]] river-like formations.",
			Introduced = "29.5",
...
A rare Predasite subspecies that prefers [[Vome (Deimos)|Vome]] appearing almost exclusively during its phase.",
			Introduced = "29.0",
			MaxAge = { Month = 3, Year = 1 },
			MaxWeight = 0.01,
			MinAge = { Month = 9, Year = 0 },
...
When roaming, Vasca Kavats will appear in groups of three, but when called from a calling point only one will spawn.",
		...
		["Panzer Vulpaphyla"] = {
			...
			Intro = "A rare Vulpaphyla subspecies that prefers [[Fass (Deimos)|Fass]] appearing almost exclusively during its phase.  
[[Vulpaphyla (Conservation)|Vulpaphylas]] can be attacked by the Infested before or after sedating, causing them to become ''Weakened''. Capturing a Vulpaphyla in this state allows them to be used as a modular [[Companion]] through a process called Revivification with [[Son]].",
			Introduced = "29.0",
			MaxAge = { Month = 2, Year = 1 },
			MaxWeight = 15,
		...
		["Pharaoh Predasite"] = {
			...
			Intro = "Predasites can be attacked by the Infested before or after sedating, causing them to become ''Weakened''. Capturing a Predasite in this state allows them to be used as a modular [[Companion]] through a process called Revivification with [[Son]]  
A rare Predasite subspecies that prefers [[Fass (Deimos)|Fass]] appearing almost exclusively during its phase.",
			Introduced = "29.0",
			MaxAge = { Month = 2, Year = 1 },
			MaxWeight = 0.01,
			MinAge = { Month = 9, Year = 0 },
		...
		["Purple Velocipod"] = {
			...
			MinWeight = 0.01,
			Notes = "A rare, purple Velocipod subspecies.  
Purple Velocipods appear to spawn more likely in the north-east.",
			Origin = "Cambion Drift",
			Rarity = "Common",
			Reward = "",
			Standing = 0,
...
Additionally, They are 75% resistant to all Warframe abilities. Meaning all Duration gets quartered. Their resistance can accumulate, causing consecutive use of the same ability to have even less duration, eventually becoming outright immune.",
		...
		["Sly Vulpaphyla"] = {
			...
			MinAge = { Month = 10, Year = 0 },
			MinWeight = 12.3,
			Notes = "A common Vulpaphyla subspecies.  
Vulpaphyla Scat marks the track alongside their footprints.",
			Origin = "Cambion Drift",
			Rarity = "Common",
			Reward = "",
			Standing = 0,
...
Despite being mentioned to travel in groups, only one Kubrodon will respond to the lure's call.",
		...
		["Vaporous Undazoa"] = {
			...
			Intro = "A rare Undazoa subspecies that prefers [[Fass (Deimos)|Fass]] appearing almost exclusively during its phase.  
Undazoa approach the Call-Point in the Exocrine, [[Cambion Drift|Cambion Drifts]] river-like formations.",
			Introduced = "29.5",
...
Additionally, They are 75% resistant to all Warframe abilities. Meaning all Duration gets quartered. Their resistance can accumulate, causing consecutive use of the same ability to have even less duration, eventually becoming outright immune.",
		...
		["White Velocipod"] = {
			...
			MinAge = { Month = 11, Year = 0 },
			MinWeight = 0,
			Notes = "A very rare, white Velocipod subspecies.  
White Velocipods appear to spawn more likely north of Infested Seraglio.",
			Origin = "Cambion Drift",
			Rarity = "Rare",
			Reward = "",
			Standing = 0,
