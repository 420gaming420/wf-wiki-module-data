---
title: "Module:Tooltips/icon/doc"
wiki_url: "https://wiki.warframe.com/w/Module/Tooltips/icon/doc"
wiki_timestamp: "2022-05-13T04:01:44Z"
---
...
:   Map that contains the basic information about a database in which a tooltip will be using. When adding new tooltips, update this map.
:   **Fields**:

    * `source` /data page link (string)
    * `loc` name(s) of subtable in the table returned by /data; nonexistant keys default to parent table; "location" (string, table)
