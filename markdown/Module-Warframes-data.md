...
return {
	...
	Necramechs = {
		Bonewidow = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "BonewidowFull.png" } },
			Health = 1880,
			HealthRank30 = 2880,
			Image = "Bonewidow.png",
			InitialEnergy = 100,
		...
		Voidrig = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "VoidrigFull.png" } },
			Health = 1400,
			HealthRank30 = 2400,
			Image = "Voidrig.png",
			InitialEnergy = 150,
	...
	Operators = {
		Drifter = {
			...
			Energy = 100,
			EnergyRank30 = 100,
			FullImages = { { TabName = "Full Body", Image = "Drifter.png" } },
			Health = 350,
			HealthRank30 = 350,
			Image = "Drifter.png",
			InitialEnergy = 100,
		...
		Operator = {
			...
			Energy = 100,
			EnergyRank30 = 100,
			FullImages = { { TabName = "Full Body", Image = "Operator.png" } },
			Health = 350,
			HealthRank30 = 350,
			Image = "Operator.png",
			InitialEnergy = 100,
	...
	Warframes = {
		Ash = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Ash.png" } },
			Health = 455,
			Helmet = "AshHelmet.png",
			Image = "Ash_Thumb.png",
			InitialEnergy = 50,
		...
		["Ash Prime"] = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "AshPrime.png" } },
			Health = 455,
			Helmet = "AshPrimeHelmet.png",
		...
		Atlas = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Atlas.png" } },
			Health = 270,
			Helmet = "AtlasHelmet.png",
		...
		["Atlas Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "AtlasPrime.png" } },
			Health = 550,
			Helmet = "AtlasPrimeHelmet.png",
		...
		Banshee = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Banshee.png" } },
			Health = 270,
			Helmet = "BansheeHelmet.png",
		...
		["Banshee Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "BansheePrime.png" } },
			Health = 270,
			Helmet = "BansheePrimeHelmet.png",
			...
			Portrait = "BansheePrime_Thumb.png",
			Progenitor = "Electricity",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 270,
		...
		Baruuk = {
			...
			FullImages = { { TabName = "Full Body", Image = "Baruuk.png" } },
			Health = 180,
			Helmet = "BaruukHelmet.png",
		...
		["Baruuk Prime"] = {
			...
			EnergyRank30 = 300,
			ExilusPolarity = "Naramon",
			FullImages = { { TabName = "Full Body", Image = "BaruukPrime.png" } },
			Health = 180,
			Helmet = "BaruukPrimeHelmet.png",
			...
			Polarities = { "Naramon", "Vazarin", "Madurai" },
			Playstyle = { "Damage", "Crowd Control" },
			Portrait = "BaruukPrime_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 365,
		...
		Brysko = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Brysko description goes here",
			Energy = 0,
			EnergyRank30 = 0,
			-- ExilusPolarity = "Naramon",
			FullImages = { { TabName = "Full Body", Image = "Brysko.png" } },
			Health = 0,
			Helmet = "BryskoHelmet.png",
			Image = "Brysko_Thumb.png",
			InitialEnergy = 0,
			InternalName = "",
			Introduced = "TBA",
			Link = "Brysko",
			MaxRank = 30,
			Name = "Brysko",
			Passive = "Brysko passive goes here",
			Playstyle = { }, -- { "Damage", "Crowd Control" },
			Polarities = { }, -- { "Vazarin", "Vazarin" },
			Portrait = "Brysko_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 0,
			Sex = "Male",
			Shield = 0,
			Sprint = 0,
			SquadPortrait = "BryskoLargePortrait.png",
			-- Subsumed = "Balefire",
			-- Tactical = "Balefire",
			Themes = "Chimera Sentient, Detective Noir",
			Type = "Warframe" ,
			_IgnoreEntry = true 
		},
		Caliban = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "Caliban.png" } },
			Health = 270,
			Helmet = "CalibanHelmet.png",
		...
		["Caliban Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "CalibanPrime.png" } },
			Health = 270,
			Helmet = "CalibanPrimeHelmet.png",
			...
			Portrait = "CalibanPrime_Thumb.png",
			Progenitor = "Electricity",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 640,
		...
		Chroma = {
			...
			Energy = 175,
			FullImages = {
				{ TabName = "Full Body", Image = "Chroma.png" },
				{ TabName = "Effigy", Image = "Chroma-Effigy.png" }
			},
			Health = 270,
			Helmet = "ChromaHelmet.png",
		...
		["Chroma Prime"] = {
			...
			EnergyRank30 = 300,
			FullImages = {
				{ TabName = "Full Body", Image = "ChromaPrime.png" },
				{ TabName = "Effigy", Image = "ChromaPrime-Effigy.png" }
			},
			Health = 270,
			Helmet = "ChromaPrimeHelmet.png",
			...
			Portrait = "ChromaPrime_Thumb.png",
			Progenitor = "Heat",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 270,
		...
		Citrine = {
			...
			Energy = 130,
			FullImages = { { TabName = "Full Body", Image = "Citrine.png" } },
			Health = 400,
			Helmet = "CitrineHelmet.png",
		...
		["Cyte-09"] = {
			...
			Energy = 180,
			FullImages = { { TabName = "Full Body", Image = "Cyte09.png" } },
			Health = 225,
			Helmet = "Cyte-09Helmet.png",
		...
		Dagath = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Dagath.png" } },
			Health = 566,
			Helmet = "DagathHelmet.png",
		...
		Dante = {
			...
			Energy = 200,
			EnergyRank30 = 270,
			FullImages = { { TabName = "Full Body", Image = "Dante.png" } },
			Health = 300,
			HealthRank30 = 390,
			Helmet = "DanteHelmet.png",
		...
		Ember = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Ember.png" } },
			Health = 270,
			Helmet = "EmberHelmet.png",
		...
		["Ember Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "EmberPrime.png" } },
			Health = 270,
			Helmet = "EmberPrimeHelmet.png",
		...
		["Equinox Prime"] = {
			...
			Portrait = "EquinoxPrime_Thumb.png",
			Progenitor = "Radiation",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 270,
		...
		Excalibur = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Excalibur.png" } },
			Health = 270,
			Helmet = "ExcaliburHelmet.png",
		...
		["Excalibur Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "ExcaliburPrime.png" } },
			Health = 270,
			Helmet = "ExcaliburPrimeHelmet.png",
			...
			Playstyle = { "Damage" },
			Polarities = { "Vazarin", "Madurai", "Madurai" },
			Portrait = "ExcaliburPrime_Thumb.png",
			Progenitor = "Electricity",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 270,
		...
		["Excalibur Umbra"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "ExcaliburUmbra.png" } },
			Health = 270,
			Helmet = "ExcaliburUmbraHelmet.png",
			...
			Portrait = "ExcaliburUmbra_Thumb.png",
			Progenitor = "Electricity",
			SellPrice = 0,
			Sex = "Male",
			Shield = 270,
		...
		["Excalibur Umbra Prime"] = {
			...
			Description = "From the shadow of the long night emerges a new Excalibur.",
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "ExcaliburUmbraPrime.png" } },
			Health = 270,
			Image = "ExcaliburUmbraPrime_Thumb.png",
			InitialEnergy = 100,
			InternalName = "/Lotus/Powersuits/Excalibur/DarkExcalibur",
			...
			Playstyle = { "Damage" },
			Polarities = { "Vazarin", "Madurai", "Madurai" },
			Helmet = "ExcaliburUmbraTherionHelmet.png",
			Portrait = "ExcaliburUmbraPrime_Thumb.png",
			Progenitor = "Electricity",
			SellPrice = 0,
			Sex = "Male",
			Shield = 270,
		...
		Follie = {
			...
			Energy = 175,
			FullImages = { 
				{ TabName = "Full Body", Image = "Follie.png" }
			},
			Health = 485,
			Helmet = "FollieHelmet.png",
			...
			MaxRank = 30,
			Name = "Follie",
			Passive = "INKBLOT: Follie's abilities coat enemies in ink that slows their movement by 50% for 10s. Afflicted enemies have a 20% chance to drop Health and Energy Orbs.",
			Playstyle = { "Crowd Control" },
		...
		Frost = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Frost.png" } },
			Health = 270,
			Helmet = "FrostHelmet.png",
		...
		["Frost Prime"] = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "FrostPrime.png" } },
			Health = 270,
			Helmet = "FrostPrimeHelmet.png",
		...
		Gara = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Gara.png" } },
			Health = 270,
			Helmet = "GaraHelmet.png",
			...
			Polarities = { "Madurai", "Madurai" },
			Portrait = "Gara_Thumb.png",
			Progenitor = "Cold",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 270,
			Sprint = 1.15,
			SquadPortrait = "GaraLargePortrait.png",
		...
		["Gara Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "GaraPrime.png" } },
			Health = 345,
			Helmet = "GaraPrimeHelmet.png",
		...
		Garuda = {
			...
			Energy = 140,
			EnergyRank30 = 240,
			FullImages = { { TabName = "Full Body", Image = "Garuda.png" } },
			Health = 270,
			Helmet = "GarudaHelmet.png",
		...
		["Garuda Prime"] = {
			...
			Energy = 220,
			EnergyRank30 = 320,
			FullImages = { { TabName = "Full Body", Image = "GarudaPrime.png" } },
			Health = 270,
			Helmet = "GarudaPrimeHelmet.png",
			...
			Playstyle = { "Damage" },
			Polarities = { "Naramon", "Vazarin", "Madurai" },
			Portrait = "GarudaPrime_Thumb.png",
			Progenitor = "Radiation",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 270,
		...
		Gauss = {
			...
			ExilusPolarity = "Naramon",
			FullImages = {
				{ TabName = "Full Body", Image = "Gauss.png" },
				{ TabName = "Redline", Image = "Gauss-Redline.png" }
			},
			Health = 270,
			Helmet = "GaussHelmet.png",
		...
		['Gauss Prime'] = {
			...
			ExilusPolarity = "Naramon",
			FullImages = {
				{ TabName = "Full Body", Image = "GaussPrime.png" },
				{ TabName = "Redline", Image = "GaussPrime-Redline.png" }
			},
			Health = 270,
			Helmet = "GaussPrimeHelmet.png",
		...
		Grendel = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Grendel.png" } },
			Health = 1095,
			HealthRank30 = 1295,
			Helmet = "GrendelHelmet.png",
		...
		['Grendel Prime'] = {
			...
			Energy = 200,
			FullImages = { { TabName = "Full Body", Image = "GrendelPrime.png" } },
			Health = 1095,
			HealthRank30 = 1295,
			Helmet = "GrendelPrimeHelmet.png",
			...
			Portrait = "GrendelPrime_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 95,
		...
		Gyre = {
			...
			Energy = 190,
			FullImages = { { TabName = "Full Body", Image = "Gyre.png" } },
			Health = 270,
			Helmet = "GyreHelmet.png",
		...
		['Gyre Prime'] = {
			...
			Energy = 190,
			FullImages = { { TabName = "Full Body", Image = "GyrePrime.png" } },
			Health = 345,
			Helmet = "GyrePrimeHelmet.png",
		...
		Harrow = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Harrow.png" } },
			Health = 270,
			Helmet = "HarrowHelmet.png",
			...
			Polarities = { "Vazarin", "Naramon" },
			Portrait = "Harrow_Thumb.png",
			Progenitor = "Magnetic",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 455,
			Sprint = 1,
			SquadPortrait = "HarrowLargePortrait.png",
			Subsumed = "Condemn",
			Tactical = "Covenant",
		...
		["Harrow Prime"] = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "HarrowPrime.png" } },
			Health = 270,
			Helmet = "HarrowPrimeHelmet.png",
			...
			Playstyle = { "Survival", "Support" },
			Polarities = { "Madurai", "Vazarin", "Naramon" },
			Portrait = "HarrowPrime_Thumb.png",
			Progenitor = "Magnetic",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 640,
		...
		Hildryn = {
			...
			FullImages = { { TabName = "Full Body", Image = "Hildryn.png" } },
			Health = 180,
			Helmet = "HildrynHelmet.png",
		...
		["Hildryn Prime"] = {
			...
			EnergyRank30 = 0,
			ExilusPolarity = "Vazarin",
			FullImages = { { TabName = "Full Body", Image = "HildrynPrime.png" } },
			Health = 270,
			Helmet = "HildrynPrimeHelmet.png",
			...
			Portrait = "HildrynPrime_Thumb.png",
			Progenitor = "Cold",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 1380,
		...
		["Hydroid Prime"] = {
			...
			Playstyle = { "Crowd Control" },
			Polarities = { "Madurai", "Vazarin", "Naramon", "Naramon" },
			Portrait = "HydroidPrime_Thumb.png",
			Progenitor = "Magnetic",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 550,
		...
		Inaros = {
			...
			ExilusPolarity = "Naramon",
			FullImages = {
				{ TabName = "Full Body", Image = "Inaros.png" },
				{ TabName = "Sarcophagus", Image = "Inaros-Sarcophagus.png" }
			},
			Health = 2110,
			HealthRank30 = 2310,
			Helmet = "InarosHelmet.png",
		...
		["Inaros Prime"] = {
			...
			ExilusPolarity = "Naramon",
			FullImages = {
				{ TabName = "Full Body", Image = "InarosPrime.png" },
				{ TabName = "Sarcophagus", Image = "InarosPrime-Sarcophagus.png" }
			},
			Health = 2215,
			HealthRank30 = 2415,
			Helmet = "InarosPrimeHelmet.png",
			...
			Portrait = "InarosPrime_Thumb.png",
			Progenitor = "Heat",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 0,
		...
		Ivara = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "Ivara.png" } },
			Health = 180,
			Helmet = "IvaraHelmet.png",
		...
		["Ivara Prime"] = {
			...
			Energy = 250,
			FullImages = { { TabName = "Full Body", Image = "IvaraPrime.png" } },
			Health = 180,
			Helmet = "IvaraPrimeHelmet.png",
		...
		Jade = {
			...
			Energy = 150,
			FullImages = {
				{ TabName = "Full Body", Image = "Jade.png" },
				{ TabName = "Glory", Image = "Jade-Glory.png" }
			},
			Health = 365,
			Helmet = "JadeHelmet.png",
		...
		Koumei = {
			...
			Energy = 122,
			EnergyRank30 = 222,
			FullImages = { { TabName = "Full Body", Image = "Koumei.png" } },
			Health = 344,
			Helmet = "KoumeiHelmet.png",
		...
		Kullervo = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Kullervo.png" } },
			Health = 1005,
			HealthRank30 = 1205,
			Helmet = "KullervoHelmet.png",
		...
		Lavos = {
			...
			Energy = 0,
			EnergyRank30 = 0,
			FullImages = { { TabName = "Full Body", Image = "Lavos.png" } },
			Health = 540,
			HealthRank30 = 740,
			Helmet = "LavosHelmet.png",
		...
		["Lavos Prime"] = {
			...
			Energy = 0,
			EnergyRank30 = 0,
			FullImages = { { TabName = "Full Body", Image = "LavosPrime.png" } },
			Health = 600,
			HealthRank30 = 800,
			Helmet = "LavosPrimeHelmet.png",
		...
		Limbo = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Limbo.png" } },
			Health = 270,
			Helmet = "LimboHelmet.png",
		...
		["Limbo Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "LimboPrime.png" } },
			Health = 270,
			Helmet = "LimboPrimeHelmet.png",
		...
		Loki = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Loki.png" } },
			Health = 180,
			Helmet = "LokiHelmet.png",
		...
		["Loki Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "LokiPrime.png" } },
			Health = 180,
			Helmet = "LokiPrimeHelmet.png",
		...
		Mag = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "Mag.png" } },
			Health = 180,
			Helmet = "MagHelmet.png",
			Image = "Mag_Thumb.png",
			InitialEnergy = 75,
		...
		["Mag Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "MagPrime.png" } },
			Health = 270,
			Helmet = "MagPrimeHelmet.png",
		...
		Mesa = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Mesa.png" } },
			Health = 365,
			Helmet = "MesaHelmet.png",
		...
		["Mesa Prime"] = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "MesaPrime.png" } },
			Health = 400,
			Helmet = "MesaPrimeHelmet.png",
		...
		Mirage = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Mirage.png" } },
			Health = 200,
			Helmet = "MirageHelmet.png",
		...
		["Mirage Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "MiragePrime.png" } },
			Health = 200,
			Helmet = "MiragePrimeHelmet.png",
			...
			Portrait = "MiragePrime_Thumb.png",
			Progenitor = "Radiation",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 310,
		...
		Nekros = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Nekros.png" } },
			Health = 270,
			Helmet = "NekrosHelmet.png",
		...
		["Nekros Prime"] = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "NekrosPrime.png" } },
			Health = 270,
			Helmet = "NekrosPrimeHelmet.png",
			...
			Playstyle = { "Crowd Control" },
			Polarities = { "Madurai", "Vazarin", "Naramon" },
			Portrait = "NekrosPrime_Thumb.png",
			Progenitor = "Toxin",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 455,
		...
		Nezha = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Nezha.png" } },
			Health = 365,
			Helmet = "NezhaHelmet.png",
		...
		["Nezha Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "NezhaPrime.png" } },
			Health = 365,
			Helmet = "NezhaPrimeHelmet.png",
		...
		Nidus = {
			...
			Energy = 100,
			FullImages = {
				{ TabName = "Full Body", Image = "Nidus.png" },
				{ TabName = "Mutated", Image = "Nidus-Mutated.png" }
			},
			Health = 675,
			Helmet = "NidusHelmet.png",
			...
			ShieldRank30 = 0,
			Sprint = 1,
			SquadPortrait = "NidusLargePortrait.png",
			Subsumed = "Larva",
			Tactical = "Larva",
		...
		["Nidus Prime"] = {
			...
			Energy = 140,
			FullImages = {
				{ TabName = "Full Body", Image = "NidusPrime.png" },
				{ TabName = "Mutated", Image = "NidusPrime-Mutated.png" }
			},
			Health = 825,
			Helmet = "NidusPrimeHelmet.png",
		...
		Nokko = {
			...
			Energy = 130,
			FullImages = {
				{ TabName = "Full Body", Image = "Nokko.png" },
				{ TabName = "Sprodling", Image = "Nokko-Sprodling.png" }
			},
			Health = 150,
			Helmet = "NokkoHelmet.png",
		...
		Nova = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Nova.png" } },
			Health = 270,
			Helmet = "NovaHelmet.png",
		...
		["Nova Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "NovaPrime.png" } },
			Health = 270,
			Helmet = "NovaPrimeHelmet.png",
		...
		Nyx = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Nyx.png" } },
			Health = 270,
			Helmet = "NyxHelmet.png",
			Image = "Nyx_Thumb.png",
			InitialEnergy = 100,
		...
		["Nyx Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "NyxPrime.png" } },
			Health = 270,
			Helmet = "NyxPrimeHelmet.png",
		...
		Oberon = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Oberon.png" } },
			Health = 365,
			Helmet = "OberonHelmet.png",
		...
		["Oberon Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "OberonPrime.png" } },
			Health = 365,
			Helmet = "OberonPrimeHelmet.png",
			...
			Portrait = "OberonPrime_Thumb.png",
			Progenitor = "Toxin",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 270,
		...
		Octavia = {
			...
			Energy = 175,
			EnergyRank30 = 225,
			FullImages = { { TabName = "Full Body", Image = "Octavia.png" } },
			Health = 270,
			Helmet = "OctaviaHelmet.png",
			...
			Polarities = { "Naramon", "Naramon" },
			Portrait = "Octavia_Thumb.png",
			Progenitor = "Radiation",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 180,
			Sprint = 1.05,
			SquadPortrait = "OctaviaLargePortrait.png",
			Subsumed = "Resonator",
			Tactical = "Resonator",
		...
		["Octavia Prime"] = {
			...
			Energy = 215,
			EnergyRank30 = 265,
			FullImages = { { TabName = "Full Body", Image = "OctaviaPrime.png" } },
			Health = 270,
			Helmet = "OctaviaPrimeHelmet.png",
			...
			Playstyle = { "Support", "Damage", "Crowd Control" },
			Polarities = { "Vazarin", "Naramon", "Naramon" },
			Portrait = "OctaviaPrime_Thumb.png",
			Progenitor = "Radiation",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 270,
		...
		Oraxia = {
			...
			Energy = 150,
			FullImages = { { TabName = "Full Body", Image = "Oraxia.png" } },
			Health = 575,
			Helmet = "OraxiaHelmet.png",
		...
		Orion = {
			...
			Energy = 200,
			FullImages = { { TabName = "Full Body", Image = "S&O-Orion.png" } },
			Health = 350,
			Helmet = "OrionHelmet.png",
			Image = "Orion_Thumb.png",
			InitialEnergy = 125,
			InternalName = "/Lotus/Powersuits/SiriusOrion/OrionSuit",
			Introduced = "43",
			Link = "Sirius & Orion#Orion",
			MaxRank = 30,
			Name = "Orion",
			Passive = "Swapping between them grants 45% Ability Efficiency for the next 2 casts.\r\n\r\nWhen below 50 energy, Sirius & Orion will steal energy from each other.",
			Playstyle = { "Damage" },
			Polarities = {  "Madurai", "Naramon", "Aura" },
			Portrait = "Orion_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 270,
			Sprint = 1.15,
			SquadPortrait = "OrionLargePortrait.png",
			Subsumed = "Astral Shell",
			Tactical = "Event Horizon",
			Themes = "Constellation, Gravity Elemental, Parallel Timelines",
			Type = "Warframe",
			_IgnoreEntry = true 
		},
		Protea = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Protea.png" } },
			Health = 270,
			Helmet = "ProteaHelmet.png",
		...
		["Protea Prime"] = {
			...
			Energy = 200,
			FullImages = { { TabName = "Full Body", Image = "ProteaPrime.png" } },
			Health = 270,
			Helmet = "ProteaPrimeHelmet.png",
			...
			Portrait = "ProteaPrime_Thumb.png",
			Progenitor = "Heat",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 455,
		...
		Qorvex = {
			...
			Energy = 150,
			FullImages = { { TabName = "Full Body", Image = "Qorvex.png" } },
			Health = 600,
			Helmet = "QorvexHelmet.png",
		...
		Revenant = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "Revenant.png" } },
			Health = 270,
			Helmet = "RevenantHelmet.png",
		...
		["Revenant Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "RevenantPrime.png" } },
			Health = 270,
			Helmet = "RevenantPrimeHelmet.png",
			...
			Portrait = "RevenantPrime_Thumb.png",
			Progenitor = "Cold",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 825,
		...
		Rhino = {
			...
			Energy = 100,
			FullImages = {
				{ TabName = "Full Body", Image = "Rhino.png" },
				{ TabName = "Iron Skin", Image = "Rhino-IronSkin.png" }
			},
			Health = 270,
			Helmet = "RhinoHelmet.png",
		...
		["Rhino Prime"] = {
			...
			Energy = 100,
			FullImages = {
				{ TabName = "Full Body", Image = "RhinoPrime.png" },
				{ TabName = "Iron Skin", Image = "RhinoPrime-IronSkin.png" }
			},
			Health = 270,
			Helmet = "RhinoPrimeHelmet.png",
		...
		Saryn = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Saryn.png" } },
			Health = 365,
			Helmet = "SarynHelmet.png",
		...
		["Saryn Prime"] = {
			...
			Energy = 200,
			EnergyRank30 = 300,
			FullImages = { { TabName = "Full Body", Image = "SarynPrime.png" } },
			Health = 365,
			Helmet = "SarynPrimeHelmet.png",
		...
		Sevagoth = {
			...
			Energy = 140,
			FullImages = { { TabName = "Full Body", Image = "Sevagoth.png" } },
			Health = 270,
			Helmet = "SevagothHelmet.png",
			...
			Playstyle = { "Damage", "Survival" },
			Polarities = { "Vazarin", "Madurai" },
			Portrait = "Sevagoth_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 235,
			Sprint = 0.95,
			SquadPortrait = "SevagothLargePortrait.png",
			Subsumed = "Gloom",
			Tactical = "Gloom",
		...
		["Sevagoth's Shadow"] = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Sevagoth-Shadow.png" } },
			Health = 270,
			Helmet = "Sevagoth'sShadowHelmet.png",
		...
		["Sevagoth Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "SevagothPrime.png" } },
			Health = 270,
			Helmet = "SevagothPrimeHelmet.png",
			...
			Portrait = "SevagothPrime_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 270,
		...
		["Sevagoth Prime's Shadow"] = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "SevagothPrime-Shadow.png" } },
			Health = 270,
			Helmet = "SevagothPrime'sShadowHelmet.png",
		...
		Sirius = {
			...
			Description = "Wield the power of the stars in a constant battle for supremacy. The dueling sons, Sirius & Orion, occupy the space of a single Warframe, jockeying for position to rain cosmic destruction upon foes.",
			Energy = 200,
			FullImages = { { TabName = "Full Body", Image = "S&O-Sirius.png" } },
			Health = 475,
			Helmet = "SiriusHelmet.png",
			Image = "Sirius_Thumb.png",
			InitialEnergy = 125,
			InternalName = "/Lotus/Powersuits/SiriusOrion/SiriusSuit",
			Introduced = "43",
			Link = "Sirius & Orion#Sirius",
			MaxRank = 30,
			Name = "Sirius",
			Passive = "Swapping between them grants 45% Ability Efficiency for the next 2 casts.\r\n\r\nWhen below 50 energy, Sirius & Orion will steal energy from each other.",
			Playstyle = { "Support" },
			Polarities = { "Vazarin", "Naramon", "Aura" },
			Portrait = "Sirius_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 355,
			Sprint = 1.15,
			SquadPortrait = "SiriusLargePortrait.png",
			Subsumed = "Jade Stars",
			Tactical = "Light's Sanctuary",
			Themes = "Constellation, Stellar Elemental, Parallel Timelines",
			Type = "Warframe",
			_IgnoreEntry = true 
		},
		["Sirius & Orion"] = { -- NOTE: Use "Sirius" and "Orion" individually to populate page data instead.
		    ...
		    Description = "Wield the power of the stars in a constant battle for supremacy. The dueling sons, Sirius & Orion, occupy the space of a single Warframe, jockeying for position to rain cosmic destruction upon foes.",
		    Energy = 200,
		    FullImages = { { TabName = "Full Body", Image = "SiriusOrion.png" } },
		    Health = 475,
		    Helmet = "SiriusOrionHelmet.png",
		    Image = "SiriusOrion.png",
		    InitialEnergy = 125,
		    InternalName = "",
		    Introduced = "43",
		    Link = "Sirius & Orion",
		    ...
		    Name = "Sirius & Orion",
		    Passive = "Swapping between them grants 45% Ability Efficiency for the next 2 casts.\r\n\r\nWhen below 50 energy, Sirius & Orion will steal energy from each other.",
		    Playstyle = { "Damage", "Support", "Crowd Control" },
		    Polarities = { "Vazarin", "Naramon", "Aura", "Madurai", "Naramon", "Aura" },
		    Portrait = "SiriusOrion.png",
		    Progenitor = "Impact",
		    SellPrice = 10000,
		    Sex = "Male",
		    Shield = 355,
		    Sprint = 1.15,
		    SquadPortrait = "SiriusOrionLargePortrait.gif",
		    -- Subsumed = "Jade Stars",
		    -- Tactical = "Light's Sanctuary",
		    Themes = "Constellation, Stellar Elemental, Gravity Elemental, Parallel Timelines",
		    Type = "Warframe",
		},
		Stalker = {
			...
			Energy = 100,
			EnergyRank30 = 150,
			FullImages = { { TabName = "Full Body", Image = "Stalker.png" } },
			Health = 455,
			HealthRank30 = 555,
			Image = "Stalker_Thumb.png",
			InitialEnergy = 50,
		...
		Styanax = {
			...
			Energy = 175,
			FullImages = {
				{ TabName = "Full Body", Image = "Styanax.png" },
				{ TabName = "Animated", Image = "Styanax_Animated.png" }
			},
			Health = 270,
			Helmet = "StyanaxHelmet.png",
		...
		["Styanax Prime"] = {
			...
			Energy = 215,
			FullImages = {
				{ TabName = "Full Body", Image = "StyanaxPrime.png" }	},
			Health = 270,
			Helmet = "StyanaxPrimeHelmet.png",
			Image = "StyanaxPrime_Thumb.png",
			InitialEnergy = 75,
			InternalName = "/Lotus/Powersuits/Hoplite/StyanaxPrime",
			Introduced = "43",
			Link = "Styanax/Prime",
			MaxRank = 30,
			Name = "Styanax Prime",
			...
			Playstyle = { "Damage", "Support" },
			Polarities = { "Vazarin", "Naramon", "Naramon" },
			Portrait = "StyanaxPrime_Thumb.png",
			Progenitor = "Cold",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 925,
			Sprint = 1,
			SquadPortrait = "StyanaxPrimeLargePortrait.png",
			Tactical = "Rally Point",
			Themes = "Astyanax, Hoplite, Peltast, Shield & Spear Paradox",
			Type = "Warframe",
			Vaulted = false
		...
		Temple = {
			...
			Energy = 165,
			FullImages = { { TabName = "Full Body", Image = "Temple.png" } },
			Health = 405,
			Helmet = "TempleHelmet.png",
		...
		Titania = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Titania.png" } },
			Health = 270,
			Helmet = "TitaniaHelmet.png",
		...
		["Titania Prime"] = {
			...
			Energy = 215,
			FullImages = { { TabName = "Full Body", Image = "TitaniaPrime.png" } },
			Health = 365,
			Helmet = "TitaniaPrimeHelmet.png",
			...
			Portrait = "TitaniaPrime_Thumb.png",
			Progenitor = "Cold",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 270,
		...
		Trinity = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Trinity.png" } },
			Health = 270,
			Helmet = "TrinityHelmet.png",
		...
		["Trinity Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "TrinityPrime.png" } },
			Health = 270,
			Helmet = "TrinityPrimeHelmet.png",
			...
			Playstyle = { "Survival", "Support" },
			Polarities = { "Vazarin", "Vazarin", "Madurai", "Naramon" },
			Portrait = "TrinityPrime_Thumb.png",
			Progenitor = "Cold",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 455,
		...
		Uriel = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Uriel.png" } },
			Health = 566,
			Helmet = "UrielHelmet.png",
		...
		Valkyr = {
			...
			Energy = 100,
			FullImages = {
				{ TabName = "Full Body", Image = "Valkyr.png" },
				{ TabName = "With Bonds", Image = "Valkyr-Bonds.png" }
			},
			Health = 650,
			Helmet = "ValkyrHelmet.png",
		...
		["Valkyr Prime"] = {
			...
			Energy = 175,
			FullImages = {
				{ TabName = "Full Body", Image = "ValkyrPrime.png" },
				{ TabName = "With Bonds", Image = "ValkyrPrime-Bonds.png" }
			},
			Health = 650,
			Helmet = "ValkyrPrimeHelmet.png",
			...
			Playstyle = { "Damage", "Survival" },
			Polarities = { "Madurai", "Madurai", "Madurai" },
			Portrait = "ValkyrPrime_Thumb.png",
			Progenitor = "Electricity",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 135,
		...
		Vauban = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "Vauban.png" } },
			Health = 270,
			Helmet = "VaubanHelmet.png",
		...
		["Vauban Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "VaubanPrime.png" } },
			Health = 270,
			Helmet = "VaubanPrimeHelmet.png",
			...
			Playstyle = { "Crowd Control" },
			Polarities = { "Naramon", "Madurai", "Vazarin" },
			Portrait = "VaubanPrime_Thumb.png",
			Progenitor = "Heat",
			SellPrice = 25000,
			Sex = "Male",
			Shield = 270,
		...
		Volt = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Volt.png" } },
			Health = 270,
			Helmet = "VoltHelmet.png",
		...
		["Volt Prime"] = {
			...
			Energy = 200,
			EnergyRank30 = 300,
			FullImages = { { TabName = "Full Body", Image = "VoltPrime.png" } },
			Health = 270,
			Helmet = "VoltPrimeHelmet.png",
		...
		Voruna = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Voruna.png" } },
			Health = 455,
			Helmet = "VorunaHelmet.png",
		...
		["Voruna Prime"] = {
			...
			Energy = 130,
			FullImages = { { TabName = "Full Body", Image = "VorunaPrime.png" } },
			Health = 455,
			Helmet = "VorunaPrimeHelmet.png",
			Image = "VorunaPrime_Thumb.png",
			InitialEnergy = 75,
			InternalName = "/Lotus/Powersuits/Werewolf/VorunaPrime",
			Introduced = "42.0.6",
			Link = "Voruna/Prime",
			MaxRank = 30,
			Name = "Voruna Prime",
			...
			Portrait = "VorunaPrime_Thumb.png",
			Progenitor = "Radiation",
			SellPrice = 10000,
			Sex = "Female",
			Shield = 270,
			Sprint = 1.2,
			SquadPortrait = "VorunaPrimeLargePortrait.png",
			Tactical = "Shroud of Dynar",
			Themes = "Wolves, Žvorūna",
			Type = "Warframe"
		},
		Wisp = {
			...
			Energy = 200,
			EnergyRank30 = 300,
			FullImages = { { TabName = "Full Body", Image = "Wisp.png" } },
			Health = 270,
			Helmet = "WispHelmet.png",
		...
		["Wisp Prime"]= {
			...
			Energy = 200,
			EnergyRank30 = 300,
			FullImages = { { TabName = "Full Body", Image = "WispPrime.png" } },
			Health = 270,
			Helmet = "WispPrimeHelmet.png",
		...
		Wukong = {
			...
			Energy = 130,
			FullImages = { { TabName = "Full Body", Image = "Wukong.png" } },
			Health = 455,
			Helmet = "WukongHelmet.png",
		...
		["Wukong Prime"] = {
			...
			Energy = 145,
			FullImages = { { TabName = "Full Body", Image = "WukongPrime.png" } },
			Health = 455,
			Helmet = "WukongPrimeHelmet.png",
			...
			Playstyle = { "Damage", "Survival" },
			Polarities = { "Naramon", "Vazarin", "Madurai" },
			Portrait = "WukongPrime_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 10000,
			Sex = "Male",
			Shield = 345,
		...
		Xaku = {
			...
			EnergyRank30 = 230,
			FullImages = {
				{ TabName = "Full Body", Image = "Xaku.png" },
				{ TabName = "Broken", Image = "Xaku-Broken.png" }
			},
			Health = 269,
			HealthRank30 = 359,
			Helmet = "XakuHelmet.png",
			...
			ShieldRank30 = 329,
			Sprint = 1.02,
			SquadPortrait = "XakuLargePortrait.png",
		...
		["Xaku Prime"] = {
			...
			EnergyRank30 = 251,
			FullImages = {
				{ TabName = "Full Body", Image = "XakuPrime.png" },
				{ TabName = "Broken", Image = "XakuPrime-Broken.png" }
			},
			Health = 269,
			HealthRank30 = 359,
			Helmet = "XakuPrimeHelmet.png",
		...
		Yareli = {
			...
			EnergyRank30 = 300,
			FullImages = {
				{ TabName = "Full Body", Image = "Yareli.png" },
				{ TabName = "Merulina", Image = "Yareli_Merulina.png" }
			},
			Health = 270,
			Helmet = "YareliHelmet.png",
		...
		["Yareli Prime"] = {
			...
			EnergyRank30 = 315,
			FullImages = {
				{ TabName = "Full Body", Image = "YareliPrime.png" },
				{ TabName = "Merulina", Image = "YareliPrime_Merulina.png" }
			},
			Health = 270,
			Helmet = "YareliPrimeHelmet.png",
			...
			Playstyle = { "Damage", "Crowd Control" },
			Polarities = { "Madurai", "Naramon", "Vazarin" },
			Portrait = "YareliPrime_Thumb.png",
			Progenitor = "Magnetic",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 550,
		...
		Zephyr = {
			...
			Energy = 100,
			FullImages = { { TabName = "Full Body", Image = "Zephyr.png" } },
			Health = 455,
			Helmet = "ZephyrHelmet.png",
		...
		["Zephyr Prime"] = {
			...
			Energy = 175,
			FullImages = { { TabName = "Full Body", Image = "ZephyrPrime.png" } },
			Health = 455,
			Helmet = "ZephyrPrimeHelmet.png",
			...
			Portrait = "ZephyrPrime_Thumb.png",
			Progenitor = "Impact",
			SellPrice = 25000,
			Sex = "Female",
			Shield = 455,
