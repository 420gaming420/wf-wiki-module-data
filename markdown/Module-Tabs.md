---
title: "Module:Tabs"
wiki_url: "https://wiki.warframe.com/w/Module/Tabs"
wiki_timestamp: "2025-01-31T14:44:35Z"
---

Scribuntu Lua port of `https://wiki. leagueoflegends.com/en-us/Template:Tabview` to enable indefinite number of tabbed pages without having to manually build the Tabview template using ugly escaped wikitext. To be used with [Template:Tabs](/w/Template:Tabs "Template:Tabs").
...
Entrypoint to creating multiple up to 20 tabs, each tab containing transcluded articles. Takes in two to multiple string arguments (max 40).

* tab<number> represents the display name of the tab
* content<number> represents the name of the transcluded page under the tab of the corresponding number Does nothing if there is no tab or content argument. Does nothing on direct invoke on articles. Must be used on a transcluded page like a template. Does nothing if used in other Lua modules. Only supports #invoke from articles.
...
* [Tabs/doc](/w/Module:Tabs/doc "Module:Tabs/doc")
...
--	* tab represents the display name of the tab
--	* content represents the name of the transcluded page under the tab of the corresponding number
