---
title: "Module:ModuleTest"
wiki_url: "https://wiki.warframe.com/w/Module/ModuleTest"
wiki_timestamp: "2022-09-24T01:55:55Z"
---

**ModuleTest** hosts the entry point to the unit test runner [Module:TestHarness](/w/Module:TestHarness "Module:TestHarness").

On this Wiki, ModuleTest is used in:

* All module's `/testcases/doc` subpages
...
**Module:<*Name*>/doc** contains an invocation to this module (`{{#invoke:ModuleTest|main}}`) and the [Category:Lua test suites](/w/Category:Lua_test_suites "Category:Lua test suites") category. The invoke will automatically find Module:<*Name*>/testcases and run all of the tests in the module, printing out the test report and cases. Any failing test cases will put the page in the [Category:Failing Lua test suites](/w/Category:Failing_Lua_test_suites "Category:Failing Lua test suites") category.  
See [Module:Math/doc](/w/Module:Math/doc "Module:Math/doc") for reference.

**Module:<*Name*>/testcases** contains any tests for member functions or objects of `p` (`p.func()` or `p.table`). Local functions and member functions preceded by two underscores (`local function func()` or `p.__func()`) are not tested.  
See [Module:Math/testcases](/w/Module:Math/testcases "Module:Math/testcases") for reference.
...
* [ModuleTest/doc](/w/Module:ModuleTest/doc "Module:ModuleTest/doc")
