...
local modData = {
	DefaultUpgrades = {
		...
		["/Lotus/Weapons/CrewShip/Laser/Blaster/BlasterInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|%  Puncture Damage",
		...
		["/Lotus/Weapons/CrewShip/ElectricTether/ElectricTetherInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|% Electricity Damage",
	...
	Sets = {
		...
		["Hunter Set"] = {
			...
			Description = "+25% Companion Damage on enemies affected by .",
		...
		["Jugulus Set"] = {
			...
			Description = "Slam attacks manifest Tendrils to lash enemies within 3m dealing 25 Puncture Damage. Cooldown: 12s",
		...
		["Saxum Set"] = {
			...
			Description = "Lifted enemies explode on death, dealing 10% Enemy Max Health as Impact Damage in a 4m radius\r\nCooldown: 6s",
	...
	Mods = {
		...
		["Abundant Mutation"] = {
			BaseDrain = 6,
			Description = "Passive Augment: Nidus gains an additional 300 max stacks of Mutation. Undying has a 30s cooldown.",
		...
		["Acid Shells"] = {
			BaseDrain = 4,
			Description = "Enemies explode on death, dealing 450 Corrosive Damage (+45% Enemy Max Health) in a 15m radius.",
		...
		["Acidic Spittle"] = {
			BaseDrain = 0,
			Description = "Every 5s spit acidic tar at an enemy within 30m, blinding them for 12s and dealing 120 Corrosive Damage.",
		...
		["Aerial Prospectus"] = {
			BaseDrain = 0,
			Conclave = false,
			Description = "Launches a beacon at an enemy within 27m that calls down an Orbital Strike dealing 1200 Blast Damage in a 7m radius.",
		...
		Afterburner = {
			BaseDrain = 6,
			Description = "Core Vent Augment: Blast Damage ignites exhaust fumes for 12s. Enemies passing through the flames take 500 Heat Damage.",
		...
		["Amalgam Argonak Metal Auger"] = {
			BaseDrain = 6,
			Class = "Amalgam",
			Description = "+3 Punch Through\r\nDamage from Daggers reduces Armor by 6.Enemies are revealed by Punch Through.",
		...
		["Amalgam Daikyu Target Acquired"] = {
			BaseDrain = 10,
			Class = "Amalgam",
			Description = "+75% to Headshot Multiplier\r\n+3% Life Steal on Nikanas60% chance to pickup used arrows.",
		...
		["Amalgam Furax Body Count"] = {
			BaseDrain = 6,
			Class = "Amalgam",
			Description = "+15s Combo Duration\r\n+45% Fire Rate for Secondary WeaponsMelee kills Blast and stagger enemies in 15m",
		...
		["Anabolic Pollination"] = {
			BaseDrain = 0,
			Description = "Release a cloud of spores that persists for 10s increasing Toxin Damage by +100% for 15s.",
		...
		["Anti-Flak Plating"] = {
			BaseDrain = 4,
			Conclave = true,
			Description = "+20 Blast Resistance\r\n-10% Mobility",
		...
		["Anti-Grav Grenade"] = {
			BaseDrain = 2,
			Description = "A grenade that levitates enemies in a 6m. After 6s afflicted enemies come crashing down, causing  Impact Damage equal to 80% of the damage taken while floating.",
		...
		Antitoxin = {
			BaseDrain = 2,
			Description = "+45% Toxin Resistance",
		...
		["Arc Coil"] = {
			BaseDrain = 2,
			Description = "Sentinel will zap up to 7 enemies within 10m, dealing 100 Electricity Damage with a 10% Status Chance.",
		...
		["Archon Continuity"] = {
			BaseDrain = 6,
			Class = "Archon",
			Description = "+55% Ability Duration\r\nAbilities that inflict a Toxin status effect will also apply a Corrosive status effect.",
		...
		["Archon Stretch"] = {
			BaseDrain = 6,
			Class = "Archon",
			Description = "+45% Ability Range\r\nAbilities that deal Electricity Damage restore +2 Energy/s over 5s.",
		...
		["Archon Vitality"] = {
			BaseDrain = 6,
			Class = "Archon",
			Description = "+100% Health\r\nStatus Effects from abilities that deal Heat Damage will be applied twice.",
		...
		["Bell Ringer"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Melee attacks knock down enemies and apply +4 Impact Status Effects",
			Icon = "BellRinger.jpg",
		...
		["Biotic Rounds"] = {
			BaseDrain = 2,
			Conclave = false,
			Description = "On Weak Point Kill:\r\n+150% Viral and Magnetic Damage and Status Chance for 15s",
		...
		["Blast Shield"] = {
			BaseDrain = 2,
			Description = "Overshields increased by +3000. Leap at an enemy within 10m dealing 30 Impact Damage and knocking down other enemies within 5m and resets Overshields.",
		...
		Bloodthirst = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "100 health stolen each hit per stack of Slash.",
		...
		["Brute Conditioning"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+385% Melee Damage\r\nConvert all base Physical Damage to Impact Damage",
		...
		["Burning Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% Heat\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to Heat damage",
		...
		["Burning Hate"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "When Hate damages enemies inflicted with Heat Status, they become vulnerable to 120% more Status Damage.",
		...
		["Cataclysmic Gate"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Sol Gate Augment : Wisp and 2 spectral images cast a single blast of Sol Gate, leaving an area with 500 Heat Damage / Second with guaranteed Heat and Radiation Status Effects for 10s. ",
		...
		["Chilling Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% Cold\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to Cold damage",
		...
		["Coil Recharge"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Coil Horizon Augment: Gyratory Sphere can be recalled. Enemies in its radius suffer 500  Electricity Damage and chain other enemies. Enemies pulled into detonation suffer additional discharges.",
		...
		["Cold Arrival"] = {
			BaseDrain = 4,
			Description = "Dismounting deals 400 Cold Damage to enemies within 4m.",
		...
		["Combustion Rounds"] = {
			...
			Incompatible = { "Primed Combustion Rounds" },
		...
		["Comet Rounds"] = {
			BaseDrain = 2,
			Conclave = true,
			Description = "20% of Damage converted into Impact",
		...
		["Condition's Perfection"] = {
			...
			IncompatibilityTags = { "POWER_WEAPON_LITE", "NO_HEAVY_ATTACK" },
		...
		["Conductive Sphere"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Arcsphere Augment: Projectiles that pass through Arcsphere have guaranteed Electricity Status Effect and +75% Electricity Damage.",
		...
		["Crescent Charge"] = {
			BaseDrain = 0,
			Description = "Charges an enemy within 25m dealing Puncture Damage and lifting them. While lifted, enemy is flung at nearby foes dealing an additional 20% of the thrown enemy's health and adding 5 Puncture Status to enemies within 5m.",
		...
		["Crescent Devolution"] = {
			BaseDrain = 0,
			Description = "Devolves into its larval form when downed and charges at enemies, dealing 100 Puncture Damage. Regains true form after 30s.",
		...
		["Da-Ren"] = {
			...
			Class = "Vazarin",
			Conclave = false,
			Description = "+300 Operator Shields\r\n+30 bonus for each Unairu School Mod",
			Icon = "Da-Ren.jpg",
			Image = "Da-RenMod.png",
		...
		["Diamond Skin"] = {
			BaseDrain = 4,
			Description = "+45% Radiation Resistance",
		...
		["Disabling Conditioning"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+385% Melee Damage\r\nConvert all base Physical Damage to Puncture Damage",
		...
		["Dispatch Overdrive"] = {
			...
			IncompatibilityTags = { "SENTINEL_WEAPON", "HOUND_WEAPON", "POWER_WEAPON_LITE", "NO_HEAVY_ATTACK" },
		...
		["Divine Retribution"] = {
			BaseDrain = 6,
			Description = "Divine Spears Augment: Status Effects spread to all speared enemies. Spear explosions scale by 1.5x of remaining Slash, Toxin and Heat Status Effects. Base Radius is 14m.",
		...
		["Endoparasitic Vector"] = {
			BaseDrain = 0,
			Description = "Transmit an endoparasite to an enemy within 30m. Tentacles spawn from it, clinging to enemies within 10m slowing them as they move further from the parasite, and dealing 20 Viral Damage/sec over 5s.",
		...
		["Fired Up"] = {
			BaseDrain = 6,
			Description = "5% Heat Damage on weapon per hit. Stacks up to 100%. Resets after 5s with no hits.",
		...
		["Flak Shot"] = {
			...
			CodexSecret = false,
			Conclave = true,
			Description = "20% of Damage converted into Slash",
			Icon = "FlakShot.png",
		...
		["Flame Repellent"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% Heat Resistance",
		...
		["Flawed Antitoxin"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% Toxin Resistance",
			Icon = "Antitoxin.png",
		...
		["Flawed Diamond Skin"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% Radiation Resistance",
			Icon = "DiamondSkin.png",
		...
		["Flawed Flame Repellent"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% Heat Resistance",
			Icon = "FlameRepellent.png",
		...
		["Flawed Insulation"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% Cold Resistance",
			Icon = "Insulation.png",
		...
		["Flawed Lightning Rod"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% Electricity Resistance",
		...
		["Focused Prospectus"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Fires a beam of energy that deals 900 Heat Damage over 4.5s.",
		...
		["Fused Crucible"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Crucible Blast Augment: Becomes a channeled ability consuming 20  Energy/s that ramps up. While active Chyrinka Pillars trigger chain reactions and their duration is frozen. Mobility is greatly reduced.",
		...
		["Gale Kick"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+100% of Melee Damage converted to Impact Damage on Jump Kick, knocking down nearby enemies on kill.",
			Icon = "GaleKick.png",
		...
		Gastro = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Regurgitate Augment: Regurgitated enemies bounce up to 3 times, creating gas clouds that last 8s and inflict nearby enemies with  Gas Status Effect.",
			Icon = "Gastro.jpg",
			Image = "GastroMod.png",
		...
		["Guardian Armor"] = {
			BaseDrain = 6,
			Description = "Vex Armor Augment: Chroma reduces the damage his squadmates within Affinity Range take by 75%. Squad kills restore 5% of his Health over 3s and increases Vex Armor duration by 1s.",
		...
		["Hallowed Eruption"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Hallowed Ground Augment: Reactivate to deal all Remaining Damage and Radiation Status.\r\nPassive: +200% Hallowed Ground Duration.",
		...
		Hemorrhage = {
			BaseDrain = 10,
			CodexSecret = false,
			Description = " Impact Status Effects have 35% chance to apply a Slash Status Effect (x2 when Fire Rate is below 2.5)",
			Icon = "Hemorrhage.png",
		...
		["Hunter Munitions"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+30% chance to apply  on Critical",
		...
		["Impaler Munitions"] = {
			...
			CodexSecret = false,
			Conclave = true,
			Description = "20% of Damage converted into Puncture",
		...
		Insulation = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% Cold Resistance",
			Icon = "Insulation.png",
		...
		["Kaal-zidi"] = { -- modData.Mods['Kaal-Zidi'] = modData.Mods['Kaal-zidi'] at the end of the table
			BaseDrain = 0,
			Class = "Unairu",
			Conclave = false,
		...
		["Kinetic Friction"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "Grinding builds up a charge that is released when landing the trick, dealing 400 Electricity Damage to enemies within 4m.",
		...
		["Leaded Gas"] = {
			BaseDrain = 2,
			Conclave = false,
			Description = "On Weak Point Hit:\r\n+300% Gas Damage and Status Chance for 6s",
			Icon = "LeadedGas.png",
		...
		["Lightning Dash"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "+24.2% to Bullet Jump\r\n+24.2% Aim Glide/Wall Latch Duration\r\n+275% Electricity on Bullet Jump",
		...
		["Lightning Rod"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% Electricity Resistance",
			Icon = "LightningRod.png",
		...
		["Loyal Retriever"] = {
			...
			IncompatibilityTags = { "VENARI_MOD" },
		...
		["Magnetic Strike"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "100% Chance to apply a Magnetic status effect when inflicting an Impact status effect",
		...
		["Magnetic Welt"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = " Impact Status Effects have 35% chance to apply a Magnetic Status Effect (x2 when Fire Rate is below 2.5)",
		...
		["Necramech Rebuke"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Electrifies enemies within 20m for 3s and dealing 300 Electricity Damage when shields are depleted.\r\n10s cooldown.",
		...
		["Negation Armor"] = {
			BaseDrain = 6,
			Description = "Scarab Shell Augment: When Inaros takes fatal damage, he consumes Scarab Shell to heal with a brief invulnerability that ends with a deadly Slash Status Effect. Cooldown 30s.",
		...
		["Noctua Swarm"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Noctua Augment: Alternate Fire releases Paragrimms that swarm 8m around the point of aim for 15s, silencing enemies and stealing their Energy for allies.",
			Icon = "NoctuaSwarm.jpg",
			Image = "NoctuaSwarmMod.png",
			InternalName = "/Lotus/Powersuits/Pagemaster/PagemasterBookAugment1Card",
			Introduced = "43.0",
			IsAbilityAugment = true,
			Link = "Noctua Swarm",
			MaxRank = 3,
		...
		["Overpressured Rounds"] = {
			...
			Icon = "OverpressuredRounds.jpg",
			Image = "OverpressuredRoundsMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Event/Nightwave/NightwaveLasGooAKAugmentMod",
			Introduced = "43.5",
			Link = "Overpressured Rounds",
			MaxRank = 5,
		...
		["Panzer Devolution"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Devolves into its larval form when downed and attacks enemies with quills, dealing 60 Viral Damage each. Regains true form after 30s.",
		...
		["Photon Overcharge"] = {
			BaseDrain = 2,
			Conclave = false,
			Description = "+90% Critical Damage\r\nOn Kill or Assist: Slain enemies have a 2% chance to drop an Energy Orb per Cold Status affecting them.",
		...
		["Polar Magazine"] = {
			...
			Incompatible = { "Primed Polar Magazine" },
		...
		["Precision Conditioning"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+385% Melee Damage\r\nConvert all base Physical Damage to Slash Damage",
		...
		["Primed Combustion Rounds"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+187% Heat",
			Icon = "CombustionRounds.png",
			Image = "PrimedCombustionRoundsMod.png",
			Incompatible = { "Combustion Rounds" },
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Rifle/Expert/ArchwingWeaponFireDamageModExpert",
			Introduced = "42.0.11",
		...
		["Primed Electrified Barrel"] = {
			...
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+187% Electricity",
			Icon = "Electrifie Barrel.png",
			Image = "PrimedElectrifiedBarrelMod.png",
			Incompatible = { "Electrified Barrel" },
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Rifle/Expert/ArchwingWeaponElectricityDamageModExpert",
			Introduced = "TBA",
			Link = "Primed Electrified Barrel",
			MaxRank = 10,
			Name = "Primed Electrified Barrel",
			Polarity = "Naramon",
			Rarity = "Legendary",
			Tradable = true,
			Transmutable = false,
		...
		["Primed Polar Magazine"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+187% Cold",
			Icon = "PolarMagazine.png",
			Image = "PrimedPolarMagazineMod.png",
			Incompatible = { "Polar Magazine" },
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Rifle/Expert/ArchwingWeaponFreezeDamageModExpert",
			Introduced = "43.5.4",
			Link = "Primed Polar Magazine",
			MaxRank = 10,
			Name = "Primed Polar Magazine",
			Polarity = "Vazarin",
			Rarity = "Legendary",
			Tradable = true,
			Transmutable = false,
		...
		["Protector Posture"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "The companion will prioritize attacking enemies within 15m of the Warframe. Attacks inflict +4  Puncture Status Effects",
		...
		["Proton Snap"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Hold Wall Latch for 2s to gain +100% Toxin Damage\r\n and +50% Status Chance for 20s.",
			Icon = "ProtonSnap.png",
		...
		["Prototype Shock Coils"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "Adds +90% Electric damage, and shots have a 20% base chance to apply extra Electric status independent of modded damage types.",
			Icon = "PrototypeShockCoils.jpg",
			Image = "PrototypeShockCoilsMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Event/Nightwave/NightwaveLasGooPistolAugmentMod",
			Introduced = "43.5",
			Link = "Prototype Shock Coils",
			MaxRank = 5,
		...
		["Razor Mortar"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Razor Gyre Augment: Groups enemies together, while Lethal Progeny's Ortholysts focus fire on those enemies with +70% Electricity Damage and Fire Rate for 6s.",
		...
		["Reflex Denial"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Generates a shield that reflects 90% Damage taken in pulses over 10s as Magnetic Damage in a 12m radius.",
		...
		["Relentless Combination"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "+100% chance to increase Melee Combo Counter when Slash Status deals damage.",
		...
		["Reroot Rampage"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Reroot Augment: Collecting Reroot orbs summons additional Sprodlings inflicting 250  Toxin Damage with increased Critical Chance each hit.",
			Icon = "RerootRampage.jpg",
			Image = "RerootRampageMod.png",
			InternalName = "/Lotus/Powersuits/Nokko/NokkoRerootAugmentCard",
			Introduced = "43.0",
			IsAbilityAugment = true,
			Link = "Reroot Rampage",
			MaxRank = 3,
		...
		["Reverse Rotorswell"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Rotorswell Augment: 35% of damage received is redirected toward the instigator as  Electricity Damage.",
		...
		["Rhythm Guard"] = {
			...
			Icon = "RhythmGuard.jpg",
			Image = "RhythmGuardMod.png",
			InternalName = "/Lotus/Powersuits/Temple/TemplePassiveAugment1Card",
			Introduced = "43.0",
			IsAbilityAugment = true,
			Link = "Rhythm Guard",
			MaxRank = 3,
		...
		["Rousing Plunder"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Plunder Augment: Plunder gains 50% max Corrosive Damage and Armor, and heals allies within Affinity range for 50 Health.",
		...
		["Sepsis Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% Toxin\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to Toxin damage",
		...
		["Shivering Contagion"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "On Cold Status Effect: 100% chance to spread that status to other enemies within 6m.",
		...
		["Shocking Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% Electricity\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to Electricity damage",
		...
		["Smite Infusion"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Smite Augment: Hold to cast will grant all allies within 15m an additional 100% Radiation Damage to their attacks for 40s.",
		...
		["Static Discharge"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "Heavy Attacks electrify nearby enemies for Electricity Damage equal to 80% of weapon damage.",
		...
		["Strain Eruption"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "Maggots explode on death, dealing 4% of an enemy's current Health as Corrosive Damage to any enemy within 8m.",
		...
		["Synergized Prospectus"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Fires a spark that seeks out the nearest enemy in 30m, dealing 300 Electricity Damage in a 10m radius. The spark ricochets up to 7x, seeking out the nearest enemy in 30m.",
		...
		["Teeming Virulence"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Virulence Augment: Hitting 4 enemies with Virulence grants 200% Primary Weapon Critical Chance for 15s.",
		...
		["Tesla Bank"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Tesla Nervos Augment: Enemy health when a Nervos is first attached is converted into a 8m burst of Electricity when killed.",
			Icon = "TeslaBank.png",
		...
		["Thermagnetic Shells"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "Enemies explode on death, dealing 80 Magnetic Damage (+40% Enemy Max Health) in a 6m radius.",
		...
		["Thrash Landing"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Landing a trick releases an explosion dealing 40% Trick Score Blast Damage to enemies within 4m.",
		...
		["Toxin Resistance"] = {
			BaseDrain = -2,
			CodexSecret = false,
			Description = "+15% Toxin Resistance",
		...
		["Trail Blazer"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "Tricks leave a trail inflicting 40 Heat Damage to enemies.",
		...
		["Untime Rift"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "The Vast Untime Augment: Creates a Rift that connects to enemies suffering from  Void Status Effect within 15m, doubling debuffs applied by The Vast Untime and maintaining  Void Status.",
			Icon = "UntimeRift.jpg",
		...
		["Kumihimo Loading"] = {
			...
			Icon = "KumihimoLoading.jpg",
			Image = "KumihimoLoadingMod.png",
			InternalName = "/Lotus/Powersuits/Koumei/KoumeiStringsAugmentCard", 
			Introduced = "43.0",
			IsAbilityAugment = true,
			Link = "Kumihimo Loading",
			MaxRank = 3,
		...
		["Viral Tempest"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Tempest Barrage Augment: Each projectile has a 100% chance of inflicting a Viral Status Effect.",
		...
		["Viral Quills"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Launches 6 quills at enemies within 20m, each dealing 60 Viral Damage with 40% Status Chance. If the target is affected by a Viral Status, a Spore is added. 4s cooldown.",
		...
		["Volatile Parasite"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Every 15s spits out a maggot that latches onto the nearest enemy, drawing fire from those within 40m. On death, the maggot bursts, dealing 100% of accumulated damage Viral Damage (+40% damage if the enemy dies while latched) to those within 10m.",
		...
		["Volatile Recompense"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Recompense Augment: Daggers whirl in a ring around Kullervo for 25s, slashing nearby foes and dealing Blast Damage and Status Effect before returning to the ring.",
		...
		["Vulcan Blitz"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "Enemies explode on death, dealing 300 Blast Damage (+60% Enemy Max Health) in a 6m radius.",
