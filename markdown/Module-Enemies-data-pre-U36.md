---
title: "Module:Enemies/data/pre-U36"
wiki_url: "https://wiki.warframe.com/w/Module/Enemies/data/pre/U36"
wiki_timestamp: "2024-06-27T05:27:23Z"
---

[Module:Enemies/data](/w/Module:Enemies/data "Module:Enemies/data") before [Update 36.0](/w/Update_36#Update_36.0 "Update 36") (2024-06-18) to the [Damage](/w/Damage "Damage") system, enemy [Armor](/w/Armor "Armor"), [Enemy Level Scaling](/w/Enemy_Level_Scaling "Enemy Level Scaling"), and enemy health [Damage Type Modifier](/w/Damage_Type_Modifier "Damage Type Modifier") changes.
...
return {
	...
	["Akkalak Turret"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Grineer/Eidolon/Avatars/EidolonAutoTurretAvatar",
			Introduced = "22",
			Link = "Akkalak Turret",
			Name = "Akkalak Turret",
			Planets = { "Earth" },
	...
	["Aurax Vertec"] = {
		General = {
			Description = "Wields a devastating ratary laser cannon. Trained to clear entire hot zones with deadly efficiency.",
			Faction = "Corpus",
	...
	Ballista = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Grineer/AIWeek/Avatars/FemaleGrineerAvatar",
			--Introduced = "?",
			Link = "Ballista",
			Name = "Ballista",
			Scans = 5,
	...
	["Deimos Mutalist Osprey Carrier"] = {
		General = {
			...
			InternalName = "",
			Introduced = "29",
			Link = "Deimos Mutalist Osprey Carrier",
			Missions = { "Excavation" },
	...
	["Deimos Swarm Mutalist MOA"] = {
		General = {
			...
			InternalName = "",
			Introduced = "29",
			Link = "Deimos Swarm Mutalist Moa",
	...
	Demolyst = {
		General = {
			Description = "A transint copy of an ally or enemy created by a Sentient from Tau energy.",
			Faction = "Corpus Amalgam",
	...
	["Exo Eviscerator"] = {
		General = {
			Description = "A Grineer specialist packing twin gratakas and able to drop mobile cover",
			Faction = "Grineer",
	...
	["Grineer Target"] = {
		General = {
			...
			Scans = 20,
			Type = "Ranged",
			Weapons = { "Grataka", "Kraken", "Miter", "Viper", "Sheev" },
		},
		Stats = {
			Health = 800,
			Armor = 60,
	...
	["Heavy Gunner"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Grineer/AIWeek/Avatars/HeavyFemaleGrineerAvatar",
			--Introduced = "?",
			Link = "Heavy Gunner",
			Name = "Heavy Gunner",
			Scans = 3,
	...
	["Hollow Thrax Centurion"] = {
		General = {
			...
			Missions = { "Yuvarium", "Duviri", "The Circuit" },
	...
	["Hyena Ng"] = {
		General = {
			Abilities = { "Blast Granade", "Fire Wave" },
	...
	["Juno Fog Comba"] = {
		General = {
			...
			TileSets = { "Corpus Ship" },
			Type = "Ranged/Melee",
			Weapons = { "Convectrix", "Ambassador", "Prova" },
		},
		Stats = {
			Health = 1100,
			Shield = 400,
	...
	["Kavor Defector"] = {
		General = {
			...
			TileSets = { "Grineer Asteroid", "Grineer Galleon", "Infested Ship" },
			Type = "Ranged",
			Weapons = { "Ignis", "Grataka", "Gorgon", "Sobek" },
		},
		Stats = {
			Health = 200,
			Armor = 50,
	...
	["Kosma Gokstad Officer"] = {
		General = {
			Abilities = { "Deploy Roller Sentry" },
			Description = "KosmaEviscerator.png",
			Faction = "Grineer",
	...
	["Kuva Jester"] = {
		General = {
			Description = "Small and agile, jumps onto its pery",
			Faction = "Kuva Grineer",
			Image = "Jester.png",
			InternalName = "",
			--Introduced = "?",
	...
	["Lynx Turret"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Corpus/QuadRobot/MiniBoss/TurretQuadMiniBossAvatar",
			--Introduced = "?",
			Link = "Lynx Turret",
			Missions = { "Orokin Sabotage", "Help Clem", "Grineer Spy" },
			Name = "Lynx Turret",
	...
	["Mordda Turret"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Grineer/Eidolon/Avatars/EidolonAutoMortarTurretAvatar",
			Introduced = "22",
			Link = "Mordda Turret",
			Name = "Mordda Turret",
			Planets = { "Earth" },
	...
	["Narmer M - Unknown (Unknown Entry)"] = {
		General = {
			--Description = "?",
			ExcludedFromSimulacrum = true,
			Faction = "Narmer",
			...
			InternalName = "",
			Introduced = "31",
			Link = "Narmer M - Unknown (Unknown Entry)",
			Missions = { "Narmer Bounty" },
			Name = "Narmer M - Unknown (Unknown Entry)",
			Planets = { "Earth" },
			--Scans = ?,
			TileSets = { "Plains of Eidolon" },
			Type = "?",
	...
	Necramech = {
		General = {
			...
			Introduced = "29",
			Link = "Necramech",
			Missions = { "Isolation Vault Bounty" },
			Name = "Necramech",
			Planets = { "Deimos" },
			Scans = 3,
			TileSets = { "Cambion Drift" },
	...
	["Rogue Culverin"] = {
		...
		Stats = {
			...
			Affinity = -1,
			BaseLevel = 1,
			Multis = { "Shoulders: 2.0x (Incarnon Compatible)" },
		}
	},
	["Rogue Voidrig"] = {
		General = {
	...
	["Senta Turret (Corpus)"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Corpus/Turrets/TurretAvatars/AutoTurretHeavyAvatar",
			--Introduced = "?",
			Link = "Senta Turret (Corpus)",
			Name = "Senta Turret (Corpus)",
			Scans = 20,
			Type = "Turret",
			Weapons = { "" },
		},
	...
	["Senta Turret (Kuva Fortress)"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Grineer/GrineerAutoTurretStaticAvatar",
			Introduced = "19",
			Link = "Senta Turret (Kuva Fortress)",
			Name = "Senta Turret (Kuva Fortress)",
			Planets = { "Kuva Fortress" },
			Scans = 20,
			TileSets = { "Grineer Asteroid Fortress" },
			Type = "Turret",
	...
	["Senta Turret (Orb Vallis)"] = {
		General = {
			...
			Faction = "Corpus",
			Image = "?",
			InternalName = "/Lotus/Types/Enemies/Corpus/Turrets/TurretAvatars/CartTurretLaserAvatar",
			Introduced = "24",
			Link = "Senta Turret (Orb Vallis)",
			Name = "Senta Turret (Orb Vallis)",
			Planets = { "Venus" },
			Scans = 20,
			TileSets = { "Orb Vallis" },
			Type = "Turret",
	...
	["The Fragmented Suzerain"] = {
		General = {
			...
			InternalName = "",
			Introduced = "35",
			Link = "The Fragmented Suzerain",
			Missions = { "Assassination", "Effervo" },
	...
	["Tyro Battalyst"] = {
		General = {
			...
			Introduced = "27",
			Link = "Tyro Battalyst",
			Missions = { "Skirmish", "Sentient Anomaly" },
			Name = "Tyro Battalyst",
			Planets = { "Veil Proxima" },
			Scans = 5,
			TileSets = { "Murex" },
	...
	["Vruush Turret"] = {
		General = {
			...
			InternalName = "/Lotus/Types/Enemies/Grineer/Eidolon/Avatars/EidolonAutoRocketTurretAvatar",
			Introduced = "22",
			Link = "Vruush Turret",
			Name = "Vruush Turret",
			Planets = { "Earth" },
