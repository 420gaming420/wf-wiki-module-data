---
title: "Module:Flaicher/DropTables"
wiki_url: "https://wiki.warframe.com/w/Module/Flaicher/DropTables"
wiki_timestamp: "2020-07-22T16:34:45Z"
---

*Documentation for this module may be created at [Module:Flaicher/DropTables/doc](/w/Module:Flaicher/DropTables/doc?action=edit&redlink=1 "Module:Flaicher/DropTables/doc (page does not exist)")*
...
local DropData = mw.loadData( 'Module:Flaicher/DropTables/data' )
...
local relicTooltipStart = "local relicTooltipStartNoDot = "local relicTooltipCenter = "\">"
local relicTooltipEnd = ""
            ...
            for rot, dropTable in Shared.skpairs(drops) do
                ...
                for j, d in pairs(dropTable) do
                    ...
                    if(d.Type == "Relic") then
                        ...
                        thisRow[RelicText] = "" .. thisRow[RelicText] .. ""
...
" end
        ...
        for i, Drop in pairs(Drops) do
            result = result.."  
"..linkSyndicate(Drop.SName)..' '..Icon._Item("Standing","","x20")..' '..Shared.formatnum(Drop.Cost)
        end
    end
