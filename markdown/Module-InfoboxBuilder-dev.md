---
title: "Module:InfoboxBuilder/dev"
wiki_url: "https://wiki.warframe.com/w/Module/InfoboxBuilder/dev"
wiki_timestamp: "2021-11-23T21:29:48Z"
---

*Documentation for this module may be created at [Module:InfoboxBuilder/dev/doc](/w/Module:InfoboxBuilder/dev/doc?action=edit&redlink=1 "Module:InfoboxBuilder/dev/doc (page does not exist)")*
...
htmlindex.srow = function(self, source, label, id, default, i18nMsgKey, category)
	...
	return self:tag('data'):attr('source', source)
		...
		:tag('format')
			:wikitext((default and default ~= 0) and ('%s%s'):format(id, default, category or '') or nil)
		:done()
		:tag('default')
			:wikitext((default and default ~= 0) and ('%s%s'):format(id, default, category or '') or nil)
		:done()
...
htmlindex.caption = function(self, source, default, i18nMsgKey)
	...
	return self:tag('data'):attr('source', source)
		:tag('default'):wikitext(default and '
