---
title: "Module:Navbox"
wiki_url: "https://wiki.warframe.com/w/Module/Navbox"
wiki_timestamp: "2025-01-31T14:44:28Z"
---

**Navbox** module to be used with [Template:LuaNavbox](/w/Template:LuaNavbox "Template:LuaNavbox")
...
`{{#invoke:Navbox|function|input1|input2|...}}`

## Documentation

### Package items

`navbox.main(frame)` (function)
:   Main module entry point. To be called with `{{#invoke:navbox|main}}` or directly from another module.
:   **Parameter**: `frame` The frame passed to the module via the #invoke. If called from another module directly, this should be a table with the parameter definition. (table)
:   **Returns**: Preprocessed navbox wikitext (string)
...
* [Navbox/doc](/w/Module:Navbox/doc "Module:Navbox/doc")
