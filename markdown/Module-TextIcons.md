---
title: "Module:TextIcons"
wiki_url: "https://wiki.warframe.com/w/Module/TextIcons"
wiki_timestamp: "2026-05-26T23:32:19Z"
---

**TextIcons** formats [text icons](/w/Text_Icons "Text Icons") closely to how they would look ingame.
...
`TextIcons.getIcon(text, options)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   Gets text with symbols replaced.
:   **Parameters**:

    :   `text` text to convert ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
    :   `options` table contains optional parameters ([table](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#table "w:c:dev:Lua reference manual"); optional)

        :   `options.class` css class to be included ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"); optional)
        :   `options.platform` specific platform (e.g. 'PC','IOS') ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"); optional)
        :   `options.size` height of the image ([number](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#number "w:c:dev:Lua reference manual"); optional)
:   **Returns**: converted text ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
...
* [TextIcons/data](/w/Module:TextIcons/data "Module:TextIcons/data")
* [TextIcons/data/doc](/w/Module:TextIcons/data/doc "Module:TextIcons/data/doc")
* [TextIcons/doc](/w/Module:TextIcons/doc "Module:TextIcons/doc")
...
')
	...
	return (text:gsub('<([%w_]+)>', function(key)
		...
		error(('getIcon(text, options): TextIcon with text "%s" and platform "%s" does not exist in [[Module:TextIcons/data]]'):format(key or '', platform or ''))
