...
wiki_timestamp: "2026-07-04T03:04:30Z"
---
...
local DamageTypes = {
	...
	Procs = {
		...
		Knockback = {
			...
			Name = "Knockback",
			Status = { "Stagger", "Increased health threshold for Mercy Kill" },
			StatusNotes = { 1, 2 } 
		},
		Disrupt = {
			Color = "#4747d1",
	...
	Types = {
		...
		Impact = {
			...
			Status = { "Stagger", "Mercy Kill Threshold +" },
			StatusNotes = { 1, 2 } 
		},
		Magnetic = {
			Color = "#4747d1",
