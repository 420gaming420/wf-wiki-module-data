---
title: "Module:Weapons/csv/doc"
wiki_url: "https://wiki.warframe.com/w/Module/Weapons/csv/doc"
wiki_timestamp: "2025-02-16T02:45:28Z"
---
...
To access CSV contents programmatically, you can use [MediaWiki's Action API](https://www.mediawiki.org/wiki/API:Main_page "mw:API:Main page") to run [Module:Weapons/csv](/w/Module:Weapons/csv "Module:Weapons/csv")'s `_csvGunComparisonTable()` or `_csvGunComparisonTable()` function.
