---
title: "Module:Lang/data/is latn data"
wiki_url: "https://wiki.warframe.com/w/Module/Lang/data/is latn data"
wiki_timestamp: "2025-01-31T14:44:20Z"
---

*Documentation for this module may be created at [Module:Lang/data/is latn data/doc](/w/Module:Lang/data/is_latn_data/doc?action=edit&redlink=1 "Module:Lang/data/is latn data/doc (page does not exist)")*

```lua
--[[--------------------------< S I N G L E S _ T >-----------------------------------------------------------

list of Latn and Zyyy (common) codepoints that are not included in  taken from Module:Unicode data/scripts
...
keys to  are decimal codepoints; other keys are language tags (always lowercase) of language
