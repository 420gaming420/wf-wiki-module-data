---
title: "Module:WDSButton"
wiki_url: "https://wiki.warframe.com/w/Module/WDSButton"
wiki_timestamp: "2022-09-24T02:56:22Z"
---
...
`wDSButton._badge(text, colorSchemeName)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   Creates a "badge"-like `wds-button`.
:   **Parameters**:

    :   `text` The text to appear inside of the badge. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
    :   `colorSchemeName` The name of the color scheme to use. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
:   **Returns**: The badge. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))

`wDSButton.badge(frame)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   Invocable version of `p. _badge`.
:   **Parameter**: `frame` Scribunto frame object. ([table](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#table "w:c:dev:Lua reference manual"))
:   **Returns**: The badge. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))

`wDSButton._bubble(text, colorSchemeName)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   Creates a "bubble"-like `wds-button`.
:   **Parameters**:

    :   `text` The text to appear inside of the bubble. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
    :   `colorSchemeName` The name of the color scheme to use. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
:   **Returns**: The bubble. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))

`wDSButton.bubble(frame)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
...
* [WDSButton/data](/w/Module:WDSButton/data "Module:WDSButton/data")
* [WDSButton/doc](/w/Module:WDSButton/doc "Module:WDSButton/doc")
