---
title: "Module:Date"
wiki_url: "https://wiki.warframe.com/w/Module/Date"
wiki_timestamp: "2022-11-29T18:46:20Z"
---

Lua module for creating Date objects for date calculations and manipulation not covered by either Mediawiki or [Scribunto](https://www.mediawiki.org/wiki/Extension:Scribunto "mw:Extension:Scribunto")'s `mw.language:formatDate()`. See <https://tieske.github.io/date/> ([Archived](https://web.archive.org/web/20221129184917/https://tieske.github.io/date/)) for documentation.
      ...
      repeat -- print(sw:aimchr())
        ...
        elseif sw("^(%d+)[/\\%s,-]?%s*") then --print("$Digits")
          ...
          if (x >= 70) or (m and d and (not y)) or (c > 3) then
            sety( x + ((x >= 100 or c>3) and 0 or x          else
