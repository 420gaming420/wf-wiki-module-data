...
wiki_url: "https://wiki.warframe.com/w/Module/Entrypoint"
wiki_timestamp: "2023-05-25T23:33:27Z"
---
...
`entrypoint(package)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   Entrypoint templating wrapper for Scribunto packages.
:   **Parameter**: `package` Scribunto package. ([table](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#table "w:c:dev:Lua reference manual"))
:   **Errors**:

    :   'you must specify a function to call' ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"); line 85)
    :   'the function you specified did not exist' ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"); line 91)
    :   '$2 is not a function' ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"); line 95; optional)
:   **Returns**: Template entrypoint - `main`. ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))

### Other items

`main(frame)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   Template entrypoint function generated by this module.
:   **Parameter**: `frame` Scribunto frame in module context. ([Frame](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual/Scribunto_libraries#Frame_object "w:c:dev:Lua reference manual/Scribunto libraries"))
...
* Parent frames are not available in Entrypoint's `frame`. This is because recursive (grandparent) frame access is impossible in legacy Scribunto due to [empty-argument expansion cache](https://www.mediawiki.org/wiki/Manual:Parser#Empty-argument_expansion_cache "mw:Manual:Parser") limitations.
...
* [Entrypoint/doc](/w/Module:Entrypoint/doc "Module:Entrypoint/doc")
...
| Wiki | [Dev Wiki](https://dev.fandom.com/wiki/Fandom_Developers_Wiki) Fork | [Module:Common](/w/Module:Common "Module:Common") ([/i18n](/w/Module:Common/i18n "Module:Common/i18n")) • [M:Docbunto](/w/Module:Docbunto "Module:Docbunto") ([/cli](/w/Module:Docbunto/cli "Module:Docbunto/cli"), [/i18n](/w/Module:Docbunto/i18n "Module:Docbunto/i18n")) • M:Entrypoint • [M:I18n](/w/Module:I18n "Module:I18n") • [M:Infobox](/w/Module:Infobox "Module:Infobox") ([/i18n](/w/Module:Infobox/i18n "Module:Infobox/i18n")) • [M:LanguageList](/w/Module:LanguageList "Module:LanguageList") • [M:Mbox](/w/Module:Mbox "Module:Mbox") ([/i18n](/w/Module:Mbox/i18n "Module:Mbox/i18n")) • [M:ModuleTest](/w/Module:ModuleTest "Module:ModuleTest") • [M:Reference](/w/Module:Reference "Module:Reference") • [M:ReleaseStatus](/w/Module:ReleaseStatus "Module:ReleaseStatus") ([/i18n](/w/Module:ReleaseStatus/i18n "Module:ReleaseStatus/i18n")) • [M:TestHarness](/w/Module:TestHarness "Module:TestHarness") ([/i18n](/w/Module:TestHarness/i18n "Module:TestHarness/i18n")) • [M:WDSButton](/w/Module:WDSButton "Module:WDSButton") ([/data](/w/Module:WDSButton/data "Module:WDSButton/data")) |
...
return function(package, default) return function(f)
    ...
    local fn_name = default or table.remove(arg_cache, 1)
