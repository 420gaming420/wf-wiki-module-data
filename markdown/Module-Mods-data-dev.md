---
title: "Module:Mods/data/dev"
wiki_url: "https://wiki.warframe.com/w/Module/Mods/data/dev"
wiki_timestamp: "2022-08-29T07:08:28Z"
---

*Documentation for this module may be created at [Module:Mods/data/dev/doc](/w/Module:Mods/data/dev/doc?action=edit&redlink=1 "Module:Mods/data/dev/doc (page does not exist)")*
...
return {
	...
	Mods = {
		...
		["Amalgam Furax Body Count"] = {
			BaseDrain = 6,
			Class = "Amalgam",
			Description = "+15s Combo Duration\r\n+20% Blast Radius on Specialized LaunchersMelee kills knockdown enemies within 15m",
		...
		["Anabolic Pollination"] = {
			BaseDrain = 0,
			Description = "Release a cloud of spores that persists for 6s increasing Toxin Damage by +100%.",
		...
		["Anti-Grav Grenade"] = {
			BaseDrain = 2,
			Description = "A grenade that reverses gravity in a 3m radius, inflicting 60 Impact Damage. Target sustains additional damage based on the amount sustained while airborne.",
		...
		["Arrow Mutation"] = {
			BaseDrain = 2,
			Description = "Converts unused ammo pickups into Arrows. Pistol/Rifle  8 and Shotgun/Sniper  15.",
		...
		["Blending Talons"] = {
			BaseDrain = 6,
			Description = "Seeking Talons Augment - Tap to perform a 9m AoE around Garuda. Garuda's Talons gain 100% additional Combo Count Chance when hitting targets affected by Bleed Status.",
		...
		Catapult = {
			BaseDrain = 6,
			Description = "Pulverize Augment:  to launch Grendel in your aim direction. Costs 10.",
		...
		["Crescent Charge"] = {
			BaseDrain = 0,
			Description = "Charge an enemy within 10m dealing 200 Puncture Damage and lifting them for 8s. While lifted, damage against them is amplified by 100%.",
		...
		["Crescent Devolution"] = {
			BaseDrain = 0,
			Description = "Devolves into its larval form upon death, and charges at enemies dealing 100 Puncture Damage. Respawns into its true form after 30s.",
		...
		["Endoparasitic Vector"] = {
			BaseDrain = 0,
			Description = "Transmit an endoparasite to an enemy within 30m. Tentacles spawn from it, clinging to enemies within 5m slowing them as they move further from the parasite, and dealing 20 Viral Damage/sec over 5s.",
		...
		["Fired Up"] = {
			BaseDrain = 6,
			Description = "+60% Heat at Max Overheat",
			...
			Upgrades = {
				{
	                ...
	                OverrideLocalization = true,
	                ReverseValueSymbol = false,
	                RoundTo = 0.1,
	                SmallerIsBetter = true,
	                UpgradeType = "WEAPON_CRIT_CHANCE",
	                ValidModifiers = { "PM_AIM" },
	                Value = 0.1091
                },
                {
                	AutoType = true,
		...
		["Hallowed Eruption"] = {
			BaseDrain = 6,
			Description = "Hallowed Ground Augment: Reactivate to deal all Remaining Damage and Radiation Status. Passive: +100% Hallowed Ground Duration.",
		...
		["Irradiating Disarm"] = {
			BaseDrain = 6,
			Description = "Radial Disarm Augment: Enemies will be affected by Radiation for 9s.",
		...
		["Larva Burst"] = {
			BaseDrain = 6,
			Description = "Larva Augment: Reactivate Larva to detonate and deal 300 Toxin Damage in a 5m radius. This damage stacks for every enemy grabbed by the Larva.",
		...
		["Necramech Rebuke"] = {
			BaseDrain = 6,
			Description = "Electrifies enemies within 20m for 3s and dealing 300 Electricity Damage when shields are depleted.10s cooldown.",
		...
		["Neutron Star"] = {
			BaseDrain = 6,
			Description = "Null Star Augment: On recast, all remaining particles will seek out enemies and deal 120 Blast Damage with guaranteed Status effect in 8m.",
		...
		["Panzer Devolution"] = {
			BaseDrain = 0,
			Description = "Devolves into its larval form upon death, and spits quills at enemies dealing 60 Viral Damage each. Respawns into its true form after 30s.",
		...
		["Piercing Roar"] = {
			BaseDrain = 6,
			Description = "Roar Augment: Enemies within 25m will be knocked down and suffer from a Puncture Status effect. Roar can be recast.",
		...
		["Pistol Ammo Mutation"] = {
			BaseDrain = 2,
			Description = "Converts unused ammo pickups into Pistol ammo. Rifle  8 and Shotgun/Sniper  15.",
		...
		["Primed Pistol Ammo Mutation"] = {
			BaseDrain = 0,
			Description = "Converts unused ammo pickups into Pistol ammo. Rifle  14 and Shotgun/Sniper  28.",
		...
		["Primed Rifle Ammo Mutation"] = {
			BaseDrain = 0,
			Description = "Converts unused Ammo Pickups into Primary Weapon Ammo. Pistol  14 and Shotgun/Sniper  28.",
		...
		["Primed Shotgun Ammo Mutation"] = {
			BaseDrain = 0,
			Description = "Converts unused ammo pickups into Shotgun ammo. Pistol/Rifle  14 and Sniper  28.",
		...
		["Primed Sniper Ammo Mutation"] = {
			BaseDrain = 0,
			Description = "Converts unused ammo pickups into Sniper ammo. Pistol/Rifle  14 and Shotgun  28.",
		...
		["Rifle Ammo Mutation"] = {
			BaseDrain = 2,
			Description = "Converts unused Ammo Pickups into Primary Weapon Ammo. Pistol  8 and Shotgun/Sniper  15.",
		...
		["Self Destruct"] = {
			BaseDrain = 2,
			Description = "Explodes on death, dealing 600 Blast Damage in a 18m radius and knocking down nearby enemies.",
			...
			Upgrades = {
				{
	                ...
	                RoundTo = 0.1,
	                SmallerIsBetter = false,
	                UpgradeType = "WEAPON_DAMAGE_TYPE_BIAS",
	                Value = 0.050000001
                }
            },
			BaseDrain = 2,
		...
		["Shocking Speed"] = {
			BaseDrain = 6,
			Description = "Speed Augment: Enemies touched while sprinting under the effects of Speed will take 175 Electricity Damage with guaranteed Status effect.",
		...
		["Shotgun Ammo Mutation"] = {
			BaseDrain = 2,
			Description = "Converts unused ammo pickups into Shotgun ammo. Pistol/Rifle  8 and Sniper  15.",
		...
		["Sniper Ammo Mutation"] = {
			BaseDrain = 2,
			Description = "Converts unused ammo pickups into Sniper ammo. Pistol/Rifle  8 and Shotgun  15.",
		...
		["Spellbound Harvest"] = {
			BaseDrain = 6,
			Description = "Spellbind Augment: Hitting at least 4 enemies with Spellbind will grant Titania 50.",
		...
		["Tesla Bank"] = {
			BaseDrain = 6,
			Description = "Tesla Nervos Augment: While a target has a Nervos attached, any damage dealt to it will be absorbed by the Nervos and channeled into a 8m burst of  Electricity on death.",
		...
		["Vigilante Supplies"] = {
			BaseDrain = 4,
			Description = "Converts unused Ammo Pickups into Primary Weapon Ammo. Pistol  6 and Shotgun/Sniper  12.",
		...
		["Volatile Parasite"] = {
			BaseDrain = 0,
			Description = "In combat, spits up a maggot every 15s. The maggot latches onto the nearest enemy and provokes other enemies within 40m to attack them. It then explodes dealing 400 Viral Damage within 10m.",
