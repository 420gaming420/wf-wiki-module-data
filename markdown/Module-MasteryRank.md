---
title: "Module:MasteryRank"
wiki_url: "https://wiki.warframe.com/w/Module/MasteryRank"
wiki_timestamp: "2026-06-12T05:39:38Z"
---

**MasteryRank** is a helper module for constructing wikitables pertaining to [Mastery Rank](/w/Mastery_Rank "Mastery Rank") and [Clan](/w/Clan "Clan") affinity.

On this Wiki, MasteryRank is used in:

* [Template:MasteryTable](/w/Template:MasteryTable "Template:MasteryTable")
* [Template:ClanAffinityTable](/w/Template:ClanAffinityTable "Template:ClanAffinityTable")
...
* [MasteryRank/dev](/w/Module:MasteryRank/dev "Module:MasteryRank/dev")
* [MasteryRank/doc](/w/Module:MasteryRank/doc "Module:MasteryRank/doc")
...
| Other | [M:Enum/data](/w/Module:Enum/data "Module:Enum/data") • [M:InternalNames](/w/Module:InternalNames "Module:InternalNames") • M:MasteryRank • [M:Polarity](/w/Module:Polarity "Module:Polarity") • [M:Sandbox](/w/Module:Sandbox "Module:Sandbox") • [M:WarframeUsageData2020/data](/w/Module:WarframeUsageData2020/data "Module:WarframeUsageData2020/data") | |
...
--  [[Mastery Rank]] and [[Clan]] affinity.  
...
(including [[Zaw]]s) || %d || %s
        ...
        ! Total !! %d !! %s%s
        |-
        ! Minus [[Exclusive Mastery|Exclusives]] !! %d !! %s%s
        |-
        |}
        ]=]):format(
