---
title: "Module:Common"
wiki_url: "https://wiki.warframe.com/w/Module/Common"
wiki_timestamp: "2022-09-23T23:19:17Z"
---

**Common** logic shared between [w:c:dev](https://en.wikipedia.org/wiki/c:dev "w:c:dev") Lua modules. Unused on the WARFRAME Wiki except for storing shared localization messages on [Module:Common/i18n](/w/Module:Common/i18n "Module:Common/i18n") subpage.
...
`common.title(frame, frame, frame)` ([function](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#function "w:c:dev:Lua reference manual"))
:   This function is used to strip language subpages from the title, and/or fetch title override arguments if necessary.
:   **Parameters**:

    :   `frame` Scribunto frame object. ([table](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#table "w:c:dev:Lua reference manual"))

        :   `frame.args` Invocation arguments table. ([table](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#table "w:c:dev:Lua reference manual"))

            :   `frame.args.Override` List of title override arguments delimited by `',%s+'`. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"); optional)
    :   `frame` Scribunto frame object. ([table](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#table "w:c:dev:Lua reference manual"))
...
:   **Returns**:
    ...
    :   Title of article for infobox/installation template use. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
    :   Title of article for infobox/installation template use. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual"))
    :   Package function output. ([string](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#string "w:c:dev:Lua reference manual")|[nil](https://en.wikipedia.org/wiki/c:dev:Lua_reference_manual#nil "w:c:dev:Lua reference manual"))
:   **Usage**:

    :   {{[common](/w/Template:Common "Template:Common")|*<"title">*|*<Override = Code,code>*}}
    :   {{[common](/w/Template:Common "Template:Common")|*<"title">*|*<Override = Code,code>*}}
    :   {{[common](/w/Template:Common "Template:Common")|*<main>*}}

## See also

* [Category:Infobox templates](/w/Category:Infobox_templates "Category:Infobox templates")
* [Category:Installation templates](/w/Category:Installation_templates?action=edit&redlink=1 "Category:Installation templates (page does not exist)")
...
* [Common/doc](/w/Module:Common/doc "Module:Common/doc")
* [Common/i18n](/w/Module:Common/i18n "Module:Common/i18n")
* [Common/i18n/doc](/w/Module:Common/i18n/doc "Module:Common/i18n/doc")
...
| Wiki | [Dev Wiki](https://dev.fandom.com/wiki/Fandom_Developers_Wiki) Fork | Module:Common ([/i18n](/w/Module:Common/i18n "Module:Common/i18n")) • [M:Docbunto](/w/Module:Docbunto "Module:Docbunto") ([/cli](/w/Module:Docbunto/cli "Module:Docbunto/cli"), [/i18n](/w/Module:Docbunto/i18n "Module:Docbunto/i18n")) • [M:Entrypoint](/w/Module:Entrypoint "Module:Entrypoint") • [M:I18n](/w/Module:I18n "Module:I18n") • [M:Infobox](/w/Module:Infobox "Module:Infobox") ([/i18n](/w/Module:Infobox/i18n "Module:Infobox/i18n")) • [M:LanguageList](/w/Module:LanguageList "Module:LanguageList") • [M:Mbox](/w/Module:Mbox "Module:Mbox") ([/i18n](/w/Module:Mbox/i18n "Module:Mbox/i18n")) • [M:ModuleTest](/w/Module:ModuleTest "Module:ModuleTest") • [M:Reference](/w/Module:Reference "Module:Reference") • [M:ReleaseStatus](/w/Module:ReleaseStatus "Module:ReleaseStatus") ([/i18n](/w/Module:ReleaseStatus/i18n "Module:ReleaseStatus/i18n")) • [M:TestHarness](/w/Module:TestHarness "Module:TestHarness") ([/i18n](/w/Module:TestHarness/i18n "Module:TestHarness/i18n")) • [M:WDSButton](/w/Module:WDSButton "Module:WDSButton") ([/data](/w/Module:WDSButton/data "Module:WDSButton/data")) |
