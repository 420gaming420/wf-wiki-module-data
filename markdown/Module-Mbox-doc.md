---
title: "Module:Mbox/doc"
wiki_url: "https://wiki.warframe.com/w/Module/Mbox/doc"
wiki_timestamp: "2021-05-08T04:39:33Z"
---

**Mbox** is a module for creating message boxes. On this Wiki, Mbox is used in:

* [Template:Ambox](/w/Template:Ambox "Template:Ambox")
...
`{{#invoke:Mbox|function|input1|input2|...}}`

### Template

In template: `{{#invoke:Mbox|__main}}`  
