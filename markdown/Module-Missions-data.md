...
**This page is actively being worked on** and may not be completely correct. Please assist in making this page accurate by [adding more info](https://wiki.warframe.com/w/Module:Missions/data?action=edit). For guidance on performing research, see [WARFRAME Wiki:Research](/w/WARFRAME_Wiki:Research "WARFRAME Wiki:Research").
...
local MissionData = {
	...
	["MissionTypes"] = {
		...
		["Skirmish + Assassinate"] = {
			Name = "Skirmish + Assassinate",
			Link = "Skirmish",
			-- Index = 32,
			Introduced = "43",
			InternalName = "",
	...
	["MissionModifiers"] = {
		...
		["Grineer Veil Proxima Point of Interest"] = {
 	...
 	["MissionDetails"] = {
		...
		{ Name = "Iron Wake", Link = "Iron Wake", Planet = "Earth", Type = "Hub", Quotes = "Iron Wake/Quotes", Tileset = "Grineer Forest", Enemy = "Tenno", MinLevel = 0, MaxLevel = 0, MasteryExp = 0, InternalName = "IronwakeHUB3", Introduced = "21", CreditReward = 0 },
		...
		{ Name = "Höllvania Central Mall", Link = "Höllvania Central Mall", Planet = "Höllvania", Type = "Hub", Quotes = "Höllvania Central Mall/Quotes", Tileset = "Höllvania", Enemy = "Tenno", MinLevel = 0, MaxLevel = 0, MasteryExp = 0, InternalName = "1999Hub", Introduced = "38", Requirements = "Must have [[The Hex (Quest)]] completed to access", CreditReward = 0 , IsTracked = false },
		...
		{ Name = "Sabmir Cloud", Link = "Sabmir Cloud", Planet = "Veil Proxima", Type = "Spy", Quotes = "Empyrean/Quotes", Tileset = "Free Space", Enemy = "Corpus", MinLevel = 57, MaxLevel = 60, DropTableAlias = "VeilProximaSpy", CacheDropTableAlias = "CorpusVeilProximaCaches", ExtraDropTableAlias = "CorpusProximaExtra", FighterMinLevel = 59, FighterMaxLevel = 62, MaxFighters = 0, MaxCrewships = 0, Objectives = 0, MasteryExp = 0, InternalName = "CrewBattleNode543", Introduced = "29.10", IsRailjack = true, PreviousNodes = { "Lu-yan" }, Requirements = "Must have [[Intrinsics]] Rank 7 or higher to access and [[Chimera Prologue]] completed", AdditionalCreditReward = 150000 },
 		...
 		{ Name = "Pontis Tower", Link = "Pontis Tower", Planet = "Uranus Proxima", Type = "Hub", Quotes = "Pontis Tower/Quotes", Tileset = "Orokin Tower", Enemy = "Tenno", MinLevel = 0, MaxLevel = 0, MasteryExp = 0, InternalName = "JadeShadows2HUB", Introduced = "43", CreditReward = 0 },
 		{ Name = "Scoria's Angel", Link = "Scoria's Angel", Image = "AshShip.png", Planet = "Uranus Proxima", Type = "Skirmish + Assassinate", Quotes = "Scoria's Angel/Quotes", Tileset = "Free Space", Enemy = "Corpus", MinLevel = 65, MaxLevel = 70, DropTableAlias = "UranusProximaScoria'sAngel", ExtraDropTableAlias = "UranusProximaExtra", FighterMinLevel = 55, FighterMaxLevel = 60, MaxFighters = 0, MaxCrewships = 0, Objectives = 0, MasteryExp = 0, InternalName = "CrewBattleNode561", Introduced = "43", IsRailjack = true, Requirements = "Must have [[Jade Shadows]] completed", AdditionalCreditReward = 0 },
 		{ Name = "The Kuva Wytch", Link = "The Kuva Wytch", Image = "GarudaShip.png", Planet = "Uranus Proxima", Type = "Skirmish + Assassinate", Quotes = "The Kuva Wytch/Quotes", Tileset = "Free Space", Enemy = "Corpus", MinLevel = 65, MaxLevel = 70, DropTableAlias = "UranusProximaTheKuvaWytch", ExtraDropTableAlias = "UranusProximaExtra", FighterMinLevel = 55, FighterMaxLevel = 60, MaxFighters = 0, MaxCrewships = 0, Objectives = 0, MasteryExp = 0, InternalName = "CrewBattleNode560", Introduced = "43", IsRailjack = true, Requirements = "Must have [[Jade Shadows]] completed", AdditionalCreditReward = 0 },
 	},
	by = { Name = {} },
	dictionary = {},
	vars = {
