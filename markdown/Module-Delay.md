---
title: "Module:Delay"
wiki_url: "https://wiki.warframe.com/w/Module/Delay"
wiki_timestamp: "2023-11-26T05:21:16Z"
---

**M:Delay** For delaying the actual requirement of a module until it is needed
...
* [Delay/doc](/w/Module:Delay/doc "Module:Delay/doc")
...
function p.require(module, data, setfunc)
	...
	elseif setfunc then
		error('p.require(module, data, setfunc): setfunc must be a function '..
			'of the type local Table; Table = delay.require_(\'Module:Table\',function(t) Table=t end)')
	end
	return setmetatable({},{
