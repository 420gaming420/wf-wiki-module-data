...
wiki_url: "https://wiki.warframe.com/w/Module/Lang/data"
wiki_timestamp: "2025-01-31T14:44:11Z"
---

*Documentation for this module may be created at [Module:Lang/data/doc](/w/Module:Lang/data/doc?action=edit&redlink=1 "Module:Lang/data/doc (page does not exist)")*
...
To see the list of names that MediaWiki has for your language, enter this in the Debug colsole:
	=mw.dumpObject (mw.language.fetchLanguageNames ('', 'all'))
(replacing  with the language tag for your language)
...
------------------------------< I S O _ 6 3 9 - 2,   - 3,   - 5 >----------------------------------------------
	...
	["lij-mc"] = "Monégasque",													-- Ligurian as spoken in Monaco; this one for proper tool tip; also in  table
...
for those rare occasions when article titles don't fit with the normal ' language', this table
