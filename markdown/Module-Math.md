---
title: "Module:Math"
wiki_url: "https://wiki.warframe.com/w/Module/Math"
wiki_timestamp: "2025-11-24T00:24:21Z"
---
...
* [Math/dev](/w/Module:Math/dev "Module:Math/dev")
* [Math/doc](/w/Module:Math/doc "Module:Math/doc")
* [Math/i18n](/w/Module:Math/i18n "Module:Math/i18n")
* [Math/i18n/doc](/w/Module:Math/i18n/doc "Module:Math/i18n/doc")
* [Math/testcases](/w/Module:Math/testcases "Module:Math/testcases")
* [Math/testcases/doc](/w/Module:Math/testcases/doc "Module:Math/testcases/doc")
* [Math/testcases/module](/w/Module:Math/testcases/module "Module:Math/testcases/module")
...
| Extensions | M:Math • [M:String](/w/Module:String "Module:String") • [M:Table](/w/Module:Table "Module:Table") |
...
local function replace(str)
	...
	:gsub("#", "")
	--sanity
	:gsub('', '^('):gsub('', ')')--superscript tags to parenthesized caret
	:gsub('<(%a+)%s[^>]+>%b{}', '')--remove misc tags that have metadata
	:gsub('<%a[^<>]+>', ''):gsub('', '')--remove misc tags
	...
	:gsub("tan%(", "𝛵(")
	:gsub("ln%(",  "♮(")
	:gsub("%f[%a]mod%f[%A]", "%%") --exact 'mod' will be replaced. Not 'mode', 'module', etc.
...
function p.round(...)
	...
	if power <= -5 or power >= 10 then
		num = num * 10^(-power)
		return formatnum(num)..'×'..formatnum(10)..''..formatnum(power)..' '
	end
