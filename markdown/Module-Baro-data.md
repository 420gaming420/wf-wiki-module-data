...
wiki_timestamp: "2026-08-21T13:03:32Z"
---
...
:   *Last updated: Fri, 21 Aug 2026 13:03:32 +0000 (UTC) by [User:Anexera](/w/User:Anexera "User:Anexera") ([change log](https://wiki.warframe.com/w/Module:Baro/data?diff=0))*
...
--		* See https://wiki.warframe.com/wiki/TennoCon for historical documentation
--	* Baro's first appearance was on 2014-12-12; from here one can calculate the Fridays in which Baro visits occur
--	* Baro skips 2019-07-13 appearance due to TennoCon 2019; this visit was moved to 2019-07-19 as per https://forums.warframe.com/topic/1109278-all-platforms-baro-kiteer-regular-schedule-resumes-july-19/

return {
	["AlwaysAvailable"] = { ["Sands of Inaros Blueprint"] = true, ["Fae Path Ephemera"] = true, ["Void Surplus"] = true }, --deprecated
	["ExtraItems"] = { -- Conditional unlock items (ones that are not included in the API)
		["Baro Void-Signal"] = {
			Condition = "Requires Inaros Prime (Equipped)",
			CreditCost = 25000,
			DucatCost = 100,
	...
	["Items"] = {
		...
		["Aged Claret of Denas"] = {
			...
			Link = "Orbiter Decorations#Baro Ki'Teer",
		...
		["Domestik Soag Drone"] = {
			CreditCost = 650000,
			DucatCost = 500,
			Image = "DomestikSoagDrone.png",
			Link = "Orbiter Decorations#Domestik Drone",
			Name = "Domestik Soag Drone",
			OfferingDates = {
				"2026-07-24"
			},
			Type = "Decoration"
		...
		["Left Eos Prime Shoulder Plates"] = {
			...
			CreditCost = 75000,
			DucatCost = 50,
			Image = "EosPrimeShoulderPlates.png",
		...
		["Rhino Palatine Sigil"] = {
			CreditCost = 55000,
			DucatCost = 45,
			Image = "RhinoPalatineSigil(SxWhite).png",
		...
		["Singing Lotus Community Glyph"] = {
			CreditCost = 2026,
			DucatCost = 20,
			Image = "SingingLotusCommunityGlyph.png",
			Link = "Glyph#Other Glyphs",
			Name = "Singing Lotus Community Glyph",
			OfferingDates = {
				"2026-07-24"
			},
			TennoConOfferingDates = {
		...
		["Sisters of Parvos Login Music"] = {
			CreditCost = 155000,
			DucatCost = 150,
			Image = "SistersOfParvosLoginMusic.png",
			Link = "Somachord",
		...
		["Verminia Cosplay Community Display"] = {
			CreditCost = 2026,
			DucatCost = 20,
			Image = "VerminiaCosplayCommunityDisplay.png",
			Link = "Orbiter Decorations#Displays",
			Name = "Verminia Cosplay Community Display",
			OfferingDates = {
				"2026-07-24"
			},
			TennoConOfferingDates = {
